<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmENegocioRegistro.aspx.vb" Inherits="Administracion_frmENegocioRegistro" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmENegocioRegistro.aspx.js"></script>
    ...
    <form id="frmMotivoRechazo" runat="server">
        ...
        <div id="dv_cuerpoModal">
    	    ...
    	    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo">Ejecutivos de Negocio</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
        ...
        <table id="tb_formulario" border="0" cellpadding="0">
         ...
         <tr>
            ...
            <td class="input">
                <select id="cmbELeasing" name="cmbELeasing" runat="server">
