<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMantBienInafectacion.aspx.vb"
    Inherits="Administracion_frmMantBienInafectacion" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmMantBienInafectacion.aspx.js"></script>
        ...
        <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <td class="botones">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_grabarInafectacion();">
