<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMantenimientoListaContrato.aspx.vb" 
    Inherits="Administracion_frmMantenimientoListaContrato" %>
...
<head runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmMantenimientoListaContrato.aspx.js"> </script>
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo" style="width: 400px">
                         Mantenimiento del Bien   ::   Búsqueda por Contrato</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
