<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmInscripcionMunicipalDetalle.aspx.vb" Inherits="Administracion_frmInscripcionMunicipalDetalle" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmInscripcionMunicipalDetalle.aspx.js"></script>
        ...
        <div id="dv_cuerpoModal">
    	    ...
    	    <tr>
			    ...
			    <td class="botones">
			    	    ...
			    	    <div id="dv_img_boton" class="dv_img_boton">
					        <a href="javascript:fn_grabarInscripcionMunicipal();">
