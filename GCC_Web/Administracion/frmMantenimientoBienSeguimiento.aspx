<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMantenimientoBienSeguimiento.aspx.vb" Inherits="Administracion_frmMantenimientoBienSeguimiento" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmMantenimientoBienSeguimiento.aspx.js"></script>
	
</head>
<body>
    <form id="frmCotizacionSeguimiento" runat="server">
        <!-- **************************************************************************************** -->
        <!-- CUERPO -->
        <!-- **************************************************************************************** -->
    	    ...
    	    <tr>
			    <td class="icono">
                    <asp:Image ID="Image1" runat="server" 
                        ImageUrl="~/Util/images/ico_seguimiento.gif" />
                </td>
			    <td class="titulos">
				    <div class="css_lbl_subTitulo">Mantenimiento Bien</div>
