...
function fn_buscarContrato() {
    ...
    fn_util_AjaxWM("frmMantenimientoListaContrato.aspx/BuscarContrato",
                    arrParametros,
                    function(jsondata) {
...
function fn_Editar() {
   // if (($('#hidSecFinanciamiento').val() != '0') && ($("#hidCodigoSolicitudCredito").val() != '')) {
    	...
    	fn_util_redirect('frmMantenimientoBienContrato.aspx');
...
function fn_Editar() {
    if (($("#hidCodigoSolicitudCredito").val() != '')) {
        fn_util_redirect('frmMantenimientoBienContrato.aspx?csc=' + $("#hidCodigoSolicitudCredito").val());
    } else {
