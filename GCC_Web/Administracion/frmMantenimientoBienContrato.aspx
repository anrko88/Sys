<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMantenimientoBienContrato.aspx.vb"
    Inherits="Administracion_frmMantenimientoBienContrato" %>
...
<head runat="server">
    ...
    <script src="frmMantenimientoBienContrato.aspx.js" type="text/javascript"></script>
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo" style="width: 400px">
                        Mantenimiento de Bien :: Bienes por Contrato
                    </div>
                </td>
                <td class="espacio">
                    &nbsp;
                                    ...
                                    <div class="dv_tabla_contenedora" style="border: 0; background: none;">
                                        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <br />
                                                    <div class="dv_img_boton_mini" id="div6" style="border: 0">
                                                    ...
                                                    <div class="dv_img_boton_mini" style="border: 0" id="div10" runat="server">
                                        ...
                                        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" style="width: 100%">
                                            <%--<tr>
                                                <td align="left">
                                                    ...
                                                    <div class="dv_img_boton_mini" style="border: 0" id="divEliminarInmueble" runat="server">
                                                        <a href="javascript:fn_EliminarBien();">
                                                            <img alt="" src="../Util/images/ico_acc_eliminar.gif" style="width: 16px; height: 16px;"
                                                                border="0" />Eliminar </a>
                                                    </div>
                                                ...
                                                <td colspan="6" align="left">
                                                    ...
                                                    <div id="dv_botonesMaquinaria" style="border: 0px">
                                                        <div class="dv_img_boton_mini" id="div4" style="border: 0">
                                                            <a href="javascript:fn_AbreRegistroMaquinaria();" style="display: inline;">
                                                                <img alt="" src="../Util/images/ico_acc_agregar.gif" style="width: 16px; height: 16px;"
                                                                    border="0" />Agregar </a>
                                                        </div>
                                                        <div class="dv_img_boton_mini" style="border: 0" id="div_eliminar_Maquinaria" runat="server">
                                                            <a href="javascript:fn_EliminarMaquinaria();">
                                                                <img alt="" src="../Util/images/ico_acc_eliminar.gif" style="width: 16px; height: 16px;"
                                                                    border="0" />Eliminar </a>
                                                        </div>
        			        ...
        			        !-->
                                <div id="tab-6">                                   
                                    <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" style="width: 100%">
                                        <tr>
                                            <td colspan="6" align="left">
                                                <div class="dv_img_boton_mini" id="div16" style="border: 0">
                                                    <a href="javascript:fn_abreNuevoDocumentoComentario();" style="display: inline;">
                                                        <img alt="" src="../Util/images/ico_acc_agregar.gif" style="width: 16px; height: 16px;"
                                                            border="0" />Agregar </a>
                                                </div>
                                                <div class="dv_img_boton_mini" style="border: 0">
                                                    <a href="javascript:fn_EliminarDocumentoComentarioMaquina();">
                                                        <img alt="" src="../Util/images/ico_acc_eliminar.gif" style="width: 16px; height: 16px;"
                                                            border="0" />Eliminar </a>
                                                </div>
                                    ...
                                    <div class="dv_tabla_contenedora" style="border: 0; background: none;">
                                        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                            <tr>
                                                ...
                                                <td colspan="6" align="left">
                                                    <br />
                                                    <div class="dv_img_boton_mini" id="div8" style="border: 0">
                                                        <a href="javascript:fn_AbreRegistroVehiculos();" style="display: inline;">
                                                            <img alt="" src="../Util/images/ico_acc_agregar.gif" style="width: 16px; height: 16px;"
                                                                border="0" />Agregar </a>
                                                    </div>
                                                    <div id="Div8" class="dv_img_boton_mini" style="border: 0" div="divEliminarVehiculo"
                                                        runat="server">
                                                        <a href="javascript:fn_EliminarVehiculo();">
                                                            <img alt="" src="../Util/images/ico_acc_eliminar.gif" style="width: 16px; height: 16px;"
                                                                border="0" />Eliminar </a>
                                                    </div>
        			        ...
        			        !-->
                                <div id="tab-7">                                   
                                    <table id="Table4" border="0" cellpadding="0" cellspacing="3" style="width: 100%">
                                        <tr>
                                            <td colspan="6" align="left">
                                                <div class="dv_img_boton_mini" id="div24" style="border: 0">
                                                    <a href="javascript:fn_abreNuevoDocumentoComentario();" style="display: inline;">
                                                        <img alt="" src="../Util/images/ico_acc_agregar.gif" style="width: 16px; height: 16px;"
                                                            border="0" />Agregar </a>
                                                </div>
                                                <div class="dv_img_boton_mini" style="border: 0">
                                                    <a href="javascript:fn_EliminarDocumentoComentarioTransporte();">
                                                        <img alt="" src="../Util/images/ico_acc_eliminar.gif" style="width: 16px; height: 16px;"
                                                            border="0" />Eliminar </a>
                                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="6" align="left">
                                                    <div id="Div12" style="border: 0px">
                                                        <div class="dv_img_boton_mini" id="div13" style="border: 0">
                                                            <a href="javascript:fn_AbreRegistroSistemasOtros();" style="display: inline;">
                                                                <img alt="" src="../Util/images/ico_acc_agregar.gif" style="width: 16px; height: 16px;"
                                                                    border="0" />Agregar </a>
                                                        </div>
                                                        <div class="dv_img_boton_mini" style="border: 0" >
                                                            <a href="javascript:fn_EliminarSistemasOtros();">
                                                                <img alt="" src="../Util/images/ico_acc_eliminar.gif" style="width: 16px; height: 16px;"
                                                                    border="0" />Eliminar </a>
                                                        </div>
        			        ...
        			        !-->
                                <div id="tab-8">
                                    ...
                                    <table id="Table1" border="0" cellpadding="0" cellspacing="3" style="width: 100%">
                                        <tr>
                                            <td colspan="6" align="left">
                                                <div class="dv_img_boton_mini" id="div18" style="border: 0">
                                                    <a href="javascript:fn_abreNuevoDocumentoComentario();" style="display: inline;">
                                                        <img alt="" src="../Util/images/ico_acc_agregar.gif" style="width: 16px; height: 16px;"
                                                            border="0" />Agregar </a>
                                                </div>
                                                <div class="dv_img_boton_mini" style="border: 0">
                                                    <a href="javascript:fn_eliminarDocumentoComentarioSistema();">
                                                        <img alt="" src="../Util/images/ico_acc_eliminar.gif" style="width: 16px; height: 16px;"
                                                            border="0" />Eliminar </a>
                                                </div>
