<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProveedorListado.aspx.vb"
    Inherits="Mantenimiento_frmProveedor" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmProveedorListado.aspx.js"> </script>
            ...
            <tr>
                ...
                <td class="botones">
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_buscarProveedor(true);">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_util_redirect('frmProveedorMant.aspx?co=0&cp=0');">
                            ...
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                <tr>
                                    ...
                                    <td class="input">
                                        ...
                                        <input type="hidden" id="hidCodProveedor" value="0" />
                                    </td>
                                    <td class="label">
                                        Nro. Documento
                                    </td>
                                    <td class="input">
                                        <input id="txtNroDocumento" type="text" class="css_input" size="12" />
                                    </td>
                                    <td class="label" style="width: 200px">
                                        Razón Social o Nombre
                                    </td>
                                    <td class="input">
                                        <input id="txtRazonSocial" type="text" class="css_input" runat="server" size="75" />
                                    </td>
                                </tr>
                            </table>
                        </div>
