<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGestionBienDocRegistro.aspx.vb" Inherits="GestionBien_frmGestionBienDocRegistro" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmGestionBienDocRegistro.aspx.js"></script>
    	    ...
    	    <tr>
			    ...
			    <td class="botones">
    				    <div id="dv_img_boton" class="dv_img_boton">
					        <a href="javascript:fn_volverListado();">
						        <img alt="" src="../Util/images/ico_acc_retornar.gif" border="0" width="35px"/><br />
						        Volver
					        </a>
				        </div>
