...
Partial Class GestionBien_ImpuestoMultasInmueble_frmImpuestoMultaInmuebleLiquidar
    Inherits GCCBase
...
#Region "   Eventos     "
    ...
    Protected Sub btnGenerar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        Dim objImpuestoMunicipal As LImpuestoMunicipalNTx = Nothing
        Try
            objImpuestoMunicipal = New LImpuestoMunicipalNTx
            table = GCCUtilitario.DeserializeObject(Of DataTable)(objImpuestoMunicipal.ListarImpuestoMunicipalReporteLiquidar(hidCodigos.Value))
        ...
        Catch ex As Exception
            ...
            GCCUtilitario.ShowError("ERROR => " + ex.Message, Me)
        Finally
            If objImpuestoMunicipal IsNot Nothing Then objImpuestoMunicipal = Nothing
...
#Region "   Web Métodos "
    <WebMethod()> _
    Public Shared Function ListaImpuestoMunicipalLiquidar(ByVal pPageSize As Integer, _
                                           ByVal pCurrentPage As Integer, _
                                           ByVal pSortColumn As String, _
                                           ByVal pSortOrder As String, _
                                           ByVal pNroLote As String) As JQGridJsonResponse
        Dim objImpuestoMunicipalTx As New LImpuestoMunicipalNTx
        'Valida Campos            

        Dim dtImpuestoVehicular As DataTable = GCCUtilitario.DeserializeObject(Of DataTable)(objImpuestoMunicipalTx.ListarImpuestoMunicipalLiquidar(pPageSize, _
                                                                                                            pCurrentPage, _
                                                                                                            pSortColumn, _
                                                                                                            pSortOrder, _
                                                                                                            pNroLote))
    ...
    End Function
    <WebMethod()> _
        Public Shared Function ListaImpuestoMunicipalLiquidarTodo(ByVal pNroLote As String) As JQGridJsonResponse
        Dim objImpuestoMunicipalTx As New LImpuestoMunicipalNTx
        'Valida Campos            

        Dim dtImpuestoVehicular As DataTable = GCCUtilitario.DeserializeObject(Of DataTable)(objImpuestoMunicipalTx.ListarImpuestoMunicipalLiquidarTodo(pNroLote))
  ...
  Public Shared Function LiquidarLote(ByVal strNroLote As String) As String
        ...
        Try
            ...
            Dim pstrCodigoConcepto As String = GCCConstante.C_CONCEPTO_IMPUESTO_MUNICIPAL
            'Ejecuta Consulta
...
#Region "   Metodos     "
    Private Sub pDescargarArchivo(ByVal ptabla As DataTable)
        ...
        Dim pTitulo As String = "REPORTE LIQUIDAR IMPUESTO Y MULTAS MUNICIPALES"
        ...
        OrderHeaderTableColumnsText.Add(txtNroLote.Value)
        ...
        OrderDataTableColumnsName.Add("Departamento")
        OrderDataTableColumnsName.Add("Provincia")
        OrderDataTableColumnsName.Add("Distrito")
        ...
        GCCUtilitario.pDescargaArchivoPagina(Me, sw.ToString(), "ImpuestoMultaMunicipalLiquidar")
    End Sub
#End Region
End Class
