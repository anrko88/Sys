<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImpuestoMultaInmuebleListado.aspx.vb"
    Inherits="GestionBien_ImpuestoMultasInmueble_frmImpuestoMultaInmuebleListado" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmImpuestoMultaInmuebleListado.aspx.js"> </script>
...
<body>
    ...
    <input type="hidden" name="hddPeriodo" id="hddPeriodo" value="" runat="server" />
    <input type="hidden" name="hddMunicipalidad" id="hddMunicipalidad" value="" runat="server" />
    <input type="hidden" name="hddNroCheque" id="hddNroCheque" value="" runat="server" />
    <input type="button" name="btnBuscarImpuestos" id="btnBuscarImpuestos" onclick="javascript:fn_realizaBusquedaImpuestoMuni();"
        style="display: none;" />
    <!-- **************************************************************************************** -->
    <!-- CUERPO -->
    <!-- **************************************************************************************** -->
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">
                        Impuestos y Multas Inmuebles :: Listado</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                <td class="botones" style="height: 60px; vertical-align: top;">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton" style="width: 60px;">
                        <a href="javascript:fn_abreLiquidar();">
                            ...
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    <td class="input">
                                        ...
                                        <input id="txtMunicipalidad" runat="server" class="css_input" size="40" />                                        <img id="imgBsqMunicipalidad" alt="" src="../../Util/images/ico_buscar.jpg" style="cursor: pointer;
                                    ...
                                    <td class="input" colspan="3">
                                        <input id="txtRazonSocial" type="text" class="css_input" size="60" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label">
                                    ...
                                    <td class="input">
                                        <input id="txtPeriodo" type="text" class="css_input" size="5" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label">
