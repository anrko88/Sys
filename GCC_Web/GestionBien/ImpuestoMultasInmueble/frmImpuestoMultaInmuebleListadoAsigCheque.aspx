<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImpuestoMultaInmuebleListadoAsigCheque.aspx.vb"
    Inherits="GestionBien_ImpuestoMultasInmueble_frmImpuestoMultaInmuebleListadoAsigCheque" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmImpuestoMultaInmuebleListadoAsigCheque.aspx.js"></script>
            ...
            <tr>
                ...
                <td class="titulos" style="width: 350px;">
                    ...
                    <div class="css_lbl_titulo">
                        Impuestos y Multas Inmuebles :: Asignar Cheque</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                    ...
                    <div class="dv_tabla_contenedora">
                        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                            <tr>
                                ...
                                <td class="input">
                                    <input id="txtLote" type="text" class="css_input" runat="server" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="input">
                                    <input id="txtNroCheque" type="text" class="css_input" runat="server" />
                                </td>
                                <td class="label" valign="top">
                                    Importe Total
                                </td>
