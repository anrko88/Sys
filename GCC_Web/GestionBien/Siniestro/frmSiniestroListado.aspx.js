...
function fn_cargaGrilla() {
     ...
     $("#jqGrid_lista_A").jqGrid({
        ...
        ondblClickRow: function(id) {
            parent.fn_blockUI();
            var rowData = $("#jqGrid_lista_A").jqGrid('getRowData', id);
            window.location = "frmSiniestroRegistro.aspx?hddCodContrato=" + rowData.CodSolicitudCredito + "&hddCodBien=" + rowData.SecFinanciamiento;
        }
    });
...
function fn_realizaBusquedaSiniestro() {
    ...
    try {
        ...
        fn_util_AjaxWM("frmSiniestroListado.aspx/ListaSiniestro",
                arrParametros,
                function(jsondata) {
...
function fn_abreEditar() {
	...
	if(fn_util_trim(codBien) == ""){
		...
		fn_util_globalRedirect("/GestionBien/Siniestro/frmSiniestroRegistro.aspx?hddCodContrato=" + $("#hddCodContrato").val() + "&hddCodBien=" + $("#hddCodBien").val());	 
	}
...
function fn_abreNuevo() {
	fn_util_globalRedirect("/GestionBien/Siniestro/frmSiniestroRegistro.aspx");
}
