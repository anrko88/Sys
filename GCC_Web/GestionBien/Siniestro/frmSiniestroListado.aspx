<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSiniestroListado.aspx.vb" Inherits="GestionBien_Siniestro_frmSiniestroListado" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmSiniestroListado.aspx.js"> </script>
        ...
        <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">Siniestro :: Listado</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
