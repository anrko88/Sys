...
Partial Class GestionBien_Tasacion_frmTasacionListado
    Inherits GCCBase
    Dim objLog As New GCCLog("frmTasacionListado.aspx.vb")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                GCCUtilitario.CargarComboValorGenerico(Me.cbmEstadoTasacionContrato, GCCConstante.C_TABLAGENERICA_ESTADO_CONTRATO)
                ...
                GCCUtilitario.CargarComboValorGenerico(Me.cmbEstadoTasacion, GCCConstante.C_TABLAGENERICA_EstadoTasaciónContrato)
...
#Region "WebMethos"
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Shared Function ListaContratosTasaciones(ByVal pPageSize As Integer, _
