<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDemandaListado.aspx.vb" Inherits="GestionBien_Demanda_frmDemandaListado" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmDemandaListado.aspx.js"> </script>
        ...
        <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">Demanda :: Listado</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                <td class="botones">
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_buscarDemanda(true);">
                        ...
                        <div class="dv_tabla_contenedora">
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                <tr>
                                    ...
                                    <td class="input">
                                        <select id="cmdEstadoContrato" name="cmdEstadoContrato" runat="server">
                                        </select>
                                    </td>
                                    <td class="label">
                                        CU Cliente
                                    ...
                                    <td class="input">
                                        <input id="txtCUCliente" type="text" class="css_input" size="10" />
                                    </td>                                    
                                </tr>
                                <tr>
                                    <td class="label">
                                    ...
                                    <td class="input">
                                        <input id="txtRazonSocial" type="text" class="css_input" size="30" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label">
                                    ...
                                    <td class="input">
                                        <input id="txtPlaca" type="text" class="css_input" size="15" />
                                    </td>
                                    <td class="label">
                                        Nº Motor
                                    </td>
                                    <td class="input">
                                        <input id="txtMotor" type="text" class="css_input" size="25" />
                                    </td>                                    
                                </tr>
                                <tr>
									<td class="label">
                                    ...
                                    <td class="input">
                                        <select id="cmdTipoBien" name="cmdTipoBien" runat="server">	
                                    ...
                                    <td colspan="3" class="input">
                                        <input id="txtUbicacion" type="text" class="css_input" size="60" />
                                    </td>                                   
                                </tr>                                   
                            </table>                                                      
                        </div>
