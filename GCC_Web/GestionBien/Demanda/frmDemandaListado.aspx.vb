...
Partial Class GestionBien_Demanda_frmDemandaListado
    Inherits GCCBase
...
#Region "WebMethods"
    ...
    Public Shared Function ListaDemanda(ByVal pPageSize As Integer, _
        ...
        Try
            ...
            'Ejecuta Consulta
            Dim dtSiniestro As DataTable = GCCUtilitario.DeserializeObject(Of DataTable)(objDemandaNTx.ListadoDemandaContrato(pPageSize, _
                                                                                                                                   pCurrentPage, _
                                                                                                                                   pSortColumn, _
                                                                                                                                   pSortOrder, _
                                                                                                                                   strEDemanda))
