<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDemandaRegistro.aspx.vb" Inherits="GestionBien_Demanda_frmDemandaRegistro" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmDemandaRegistro.aspx.js"> </script>
...
<body>
    ...
    <div id="dv_cuerpo">
        ...
        <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="icono">
                    <img alt="" src="../../Util/images/ico_mdl_demanda.gif" class="jd_menu_icono" />
                </td>
                <td class="titulos">
                    <div class="css_lbl_subTitulo">Gestión del Bien</div>
                    <div class="css_lbl_titulo">Demanda :: Registro</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
		...
		<input type="button" name="btnBuscar" id="btnBuscar" onclick="javascript:fn_buscaDemanda();" style="display: none;" />
            ...
            <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="cuerpo">
                        ...
                        <div class="dv_tabla_contenedora">
							...
							<table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
								...
								<tr>
									...
									<td class="input">
										<input id="txtPlaca" type="text" class="css_input" runat="server" size="15" />
									</td>
									<td class="label">
										Descripción del Bien
									</td>
									<td class="input">
										<input id="txtDescripcion" type="text" class="css_input" runat="server" size="50" />
									</td>									
									<td class="label">
										Ubicación
									</td>
                        ...
                        <table id="tb_tabla_comunCabecera" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="titulo css_lbl_tituloContenido">Listado de Demandas</td>							
							</tr>
						</table>
                                    ...
                                    <tr>
                                        <td colspan="6" style="text-align: right; padding-right: 5px">
                                            <div id="dv_eliminar" class="dv_img_boton_mini" style="width: 60px; border: 0px solid #ffffff;"
                                                runat="server">
                                                <a href="javascript:fn_eliminarDemanda();">
                                            ...
                                            <div id="dv_editar" class="dv_img_boton_mini" style="width: 60px; border: 0px solid #ffffff;"
                                                runat="server">
                                                <a href="javascript:fn_editarDemanda();">
                                            ...
                                            <div id="dv_agregar" class="dv_img_boton_mini" style="width: 60px; border: 0px solid #ffffff;"
                                                dir="ltr">
                                                <a href="javascript:fn_agregarDemanda();">
                                            ...
                                            <div id="dv_ver" class="dv_img_boton_mini" style="width: 100px; border: 0px solid #ffffff;"
                                                runat="server">
                                                <a href="javascript:fn_verDemanda();">
