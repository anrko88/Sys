...
function fn_CargaData() {
    if ($("#txtNroLote").val() != "") {
        ...
        fn_util_AjaxSyncWM("frmImpuestoVehicularAsigCheque.aspx/ObtieneDatosLote",
            arrParametros,
                fn_PonerDatos,
                        function(resultado) {
                            parent.fn_unBlockUI();
        ...
        if (strValidacion != '2' && strValidacion != '-1') {
            parent.fn_mdl_confirma(strError, //Mensaje - Obligatorio
                            function() {
                                ...
                                parent.fn_blockUI();
                                fn_util_AjaxWM("frmImpuestoVehicularAsigCheque.aspx/AsignarCheque",
                 arrParametros,
                 function(result) {
                     parent.fn_unBlockUI();
...
function fn_Validacion() {
    ...
    if ($("#txtCheque") != '') {
        ...
        fn_util_AjaxWM("frmImpuestoVehicularAsigCheque.aspx/ValidaLotesCheque",
                 arrParametros,
                 fn_DatosObtenidos,
                 function(resultado) {
                     parent.fn_unBlockUI();
