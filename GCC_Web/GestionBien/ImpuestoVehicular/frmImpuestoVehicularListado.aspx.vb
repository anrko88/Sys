...
Imports GCC.Entity
Imports GCC.LogicWS
Partial Class GestionBien_ImpuestoVehicular_frmImpuestoVehicularListado
    Inherits GCCBase
...
#Region "Eventos"
   ...
   Public Shared Function CheckLote(ByVal pNroLote As String) As String
        ...
        Dim flag As String = GCCConstante.C_LOTE_IMP_VEHICULAR ' Para impuesto vehicular el flag es 0
