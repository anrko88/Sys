<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImpuestoVehicularMasivoResumenCarga.aspx.vb" Inherits="GestionBien_ImpuestoVehicular_frmImpuestoVehicularMasivoResumenCarga" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmImpuestoVehicularMasivoResumenCarga.aspx.js"> </script>

</head>
<body>
    <form id="frmImpuestoVehicularMasivoResumenCarga" runat="server">
    <!-- **************************************************************************************** -->
    <!-- CUERPO -->
    <!-- **************************************************************************************** -->
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">
                        Impuesto Vehicular :: Resumen de Carga</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                <td class="botones" style="height: 60px; vertical-align: top;">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_Verificar();">
                            <img src="../../Util/images/ico_acc_ejecutarWIO.gif" border="0" /><br />
                            Verificar </a>
                    </div>
                </td>
            </tr>
                        ...
                        <div class="dv_tabla_contenedora">
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                <tr>
                                    ...
                                    <td class="input">
                                        <select id="ddlEstadoCarga" runat="server" name="ddlEstadoCarga">
                                    ...
                                    <td class="input">
                                        <input id="txtTotalCorrecto" type="text" class="css_input_inactivo" disabled="true" />
                                    </td>
                                </tr>
