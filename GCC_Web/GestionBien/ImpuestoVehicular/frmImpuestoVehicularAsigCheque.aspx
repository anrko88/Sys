<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImpuestoVehicularAsigCheque.aspx.vb"
    Inherits="GestionBien_ImpuestoVehicular_frmImpuestoVehicularAsigCheque" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmImpuestoVehicularAsigCheque.aspx.js"> </script>
    ...
    <div id="dv_cuerpoModal">
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">
                        Impuesto Vehicular : Asignar Cheque</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
        ...
        <table id="tb_formulario" border="0" cellpadding="0">
            <tr>
                ...
                <td class="input">
                    <input id="txtMunicipalidad" type="text" class="css_input" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="label" valign="top">
                ...
                <td class="input">
                    <input id="txtImporteTotal" type="text" class="css_input" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="label" valign="top">
                ...
                <td class="input">
                    <input id="txtFechaPago" type="text" class="css_input" runat="server" />
                </td>
                <td class="label" valign="top">
                    Fecha de Generación
                </td>
                <td class="input">
                    <input id="txtFechaGeneracion" type="text" class="css_input" runat="server" />
                </td>
            </tr>
        </table>
    </div>
