<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImpuestoVehicularLiquidar.aspx.vb"
    Inherits="GestionBien_ImpuestoVehicular_frmImpuestoVehicularLiquidar" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmImpuestoVehicularLiquidar.aspx.js"> </script>

</head>
<body>
    <form id="frmImpuestoVehicularLiquidar" runat="server">
    <!-- **************************************************************************************** -->
    <!-- CUERPO -->
    <!-- **************************************************************************************** -->
    <div id="dv_cuerpo">
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">
                        Impuesto Vehicular :: Liquidación</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
            ...
            <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="cuerpo">
                        ...
                        <input id="hddCondicionMensaje" type="hidden" runat="server" />
                        <div class="dv_tabla_contenedora">
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="4">
                                <tr>
                                    <td class="label">
                                        Nº Lote
                                    </td>
                        ...
                        <%-- <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                <tr>
                                    ...
                                    <td class="input">
                                        <input id="txtTotal" type="text" class="css_input" />
                                    </td>
                                </tr>
                            </table>--%>
                    </td>
