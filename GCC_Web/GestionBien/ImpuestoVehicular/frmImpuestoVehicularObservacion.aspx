<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImpuestoVehicularObservacion.aspx.vb" Inherits="GestionBien_ImpuestoVehicular_frmImpuestoVehicularObservacion" %>
        ...
        <div id="dv_cuerpoModal">
    	    ...
    	    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo">Impuesto Vehicular :: Observación</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
