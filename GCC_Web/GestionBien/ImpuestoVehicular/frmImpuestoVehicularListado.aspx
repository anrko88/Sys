<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmImpuestoVehicularListado.aspx.vb" Inherits="GestionBien_ImpuestoVehicular_frmImpuestoVehicularListado" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmImpuestoVehicularListado.aspx.js"> </script>
                ...
                <td class="botones" style="height:60px;vertical-align:top;">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_abreEditar('')">
                            <img alt="" src="../../Util/images/ico_acc_editar.gif" border="0" 
