<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRepSunatOpcionesCompra.aspx.vb" Inherits="Reportes_frmRepSunatOpcionesCompra" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmRepSunatOpcionesCompra.aspx.js"> </script>
</head>
<body>
                ...
                <tr>
                    ...
                    <td class="titulos">
                        ...
                        <div class="css_lbl_titulo">
                            Reporte Sunat Opciones de Compra</div>
                    </td>
                    <td class="espacio">
                        &nbsp;
                    </td>
