<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMultaVehicularObservacion.aspx.vb" Inherits="GestionBien_MultaVehicular_frmMultaVehicularObservacion" %>
...
<body>
    <form id="frmContratoSeguimiento" runat="server">
    	    ...
    	    <tr>
			    <td class="icono">
                    <asp:Image ID="Image1" runat="server" 
                        ImageUrl="~/Util/images/ico_mdl_multa.gif" />
                </td>
			    <td class="titulos">
				    <div class="css_lbl_subTitulo">Gestión del Bien</div>
				    <div class="css_lbl_titulo">Multa Vehicular :: Observación</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
        ...
        <tr>
            <td class="label" valign="top" style="vertical-align: top">Observación</td>
            <td class="input">
