<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMotivoRechazo.aspx.vb" Inherits="Cotizacion_frmMotivoRechazo" %>
    ...
    <form id="frmMotivoRechazo" runat="server">
        ...
        <div id="dv_cuerpoModal">
    	    ...
    	    <tr>
			    ...
			    <td class="titulos">
				    <div class="css_lbl_subTitulo">Check List Legal</div>
				    <div class="css_lbl_titulo">Seguimiento Contrato</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
        ...
        <table id="tb_formulario" border="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="input">
                <input id="txtFecha" type="text" class="css_input" size="8" runat="server" readonly="readonly"/>
            </td>
          </tr>
          <tr>
            <td class="label">
            ...
            <td class="input">
                <select id="cmbTipoMotivo" runat="server">
                </select>
             </td>
          </tr>
          <tr>
