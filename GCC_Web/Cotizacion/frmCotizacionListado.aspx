<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCotizacionListado.aspx.vb"
    Inherits="Cotizacion_frmCotizacionListado" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmCotizacionListado.aspx.js"> </script>

</head>
<body>
    <form id="frmCotizacionListado" runat="server">
    <!-- **************************************************************************************** -->
    <!-- CUERPO -->
    <!-- **************************************************************************************** -->
    <div id="dv_cuerpo">
            ...
            <tr>
                ...
                <td class="titulos">
                    <div class="css_lbl_subTitulo">
                        Cotización y Negociación</div>
                    <div class="css_lbl_titulo">
                        Cotización :: Listado</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                <td class="botones">
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_buscarCotizacion(true);">
                    ...
                    <!--
				    <div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_ImportarCronograma();" title="Importar Cronograma">
            ...
            <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="cuerpo">
                        ...
                        <input type="hidden" name="hddCodigoCotizacion" id="hddCodigoCotizacion" value="" runat="server" />
                        <input type="hidden" name="hddNroCotizacion" id="hddNroCotizacion" value="" runat="server" />
                        <input type="button" name="btnBuscar" id="btnBuscar" onclick="javascript:fn_buscarCotizacion(true);" style="display: none;" />
                        ...
                        <div class="dv_tabla_contenedora">
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                <tr>
                                    ...
                                    <td class="input">
                                        <input id="txtNroCotizacion" type="text" class="css_input" />
                                    </td>
                                    <td class="label">
                                        CU. Cliente
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="input">
                                        <select id="cmbEjecutivo" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td class="input">
                                        <select id="cmbEstado" runat="server">
                                        </select>
                                    </td>
                                </tr>
                            </table>                                                      
        ...
        <input type="button" name="btnListar" id="btnListar" onclick="javascript:fn_buscarCotizacion(true);" style="display:none;" />
        <asp:Button ID="btnProbarCarta" Text="Probar Carta" runat="server" style="display:none;"   />
        <iframe id="ifrm_carta" src="" frameborder="1" scrolling="no" width="1" height="1" style="display:none;">
        </iframe>
        <!-- Fin Cuerpo -->
    </div>
    </form>
