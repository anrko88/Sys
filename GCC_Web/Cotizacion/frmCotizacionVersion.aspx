<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCotizacionVersion.aspx.vb" Inherits="Cotizacion_frmCotizacionVersion" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Cotización Version</title>
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmCotizacionVersion.aspx.js"></script>
	
</head>
<body>
    <form id="frmCotizacionVersion" runat="server">
    	    ...
    	    <tr>
			    <td class="icono">
                    <asp:Image ID="Image1" runat="server" 
                        ImageUrl="~/Util/images/ico_version.gif" />
                </td>
			    <td class="titulos">
				    <div class="css_lbl_subTitulo">Cotización y Negociación</div>
				    <div class="css_lbl_titulo">Versiones</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
                    ...
                    <div id="dv_img_botonVer" class="dv_img_boton">
                        <a href="javascript:fn_abrirVer();">
	    ...
	    <input type="hidden" name="hddVersionCotizacion" id="hddVersionCotizacion" value="" runat="server" />
