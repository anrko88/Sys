<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmFiltroRepSunatContrato.aspx.vb"
    Inherits="Reportes_frmFiltroRepSunatContrato" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Reporte Sunat Contrato</title>
    <!-- Icono URL -->
    ...
    <script type='text/javascript' src="frmFiltroRepSunatContrato.aspx.js"> </script>
                    ...
                    <td class="cuerpo">
                        ...
                        <div id="dv_datos" class="dv_tabla_contenedora">
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" style="width: 520px;">
                                <tr>
                                    <td class="label" style="width: 210px">
                                ...
                                <tr>
                                    <td class="label" style="width: 210px">
                                        Fecha de Celebración Contrato Desde
                                    </td>
                                    <td class="input">
                                        <input id="txtFechaCelConIni" name="txtFechaCelConIni" type="text" class="css_input"
                                            size="12" runat="server" title="Fecha de Celebración Contrato Desde" />
                                    </td>
                                    <td class="label" style="width: 70px">
                                        Hasta
                                    </td>
                                    <td class="input">
                                        <input id="txtFechaCelConFin" name="txtFechaCelConFin" type="text" class="css_input"
                                            size="12" runat="server" title="Fecha de Celebración Contrato Hasta" />
                                    </td>
                                </tr>
                            </table>
                        </div>
