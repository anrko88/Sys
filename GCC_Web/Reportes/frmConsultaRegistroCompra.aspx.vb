...
Imports System.Text
Partial Class Reportes_frmConsultaRegistroCompra
    Inherits GCCBase

    Dim objLog As New GCCLog("frmConsultaRegistroCompra.aspx.vb")
    ...
    Protected Sub btnGenerar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        Dim newFile As New FileInfo(HttpContext.Current.Server.MapPath("../temp/ReporteCompras.xlsm"))
        Dim template As New FileInfo(HttpContext.Current.Server.MapPath("../Util/Plantillas/Reportes/LSG_rptRegCompras.xlsm"))
        Try

            table = GCCUtilitario.DeserializeObject(Of DataTable)(objUtilNTx.ListarRegistrosCompras(hddFecInicio.Value, hddFecFin.Value))
            ...
            Dim worksheet As ExcelWorksheet = pck.Workbook.Worksheets("Registro de Compras")
            ...
            Next
            pck.Save()
            Response.Redirect("../temp/ReporteCompras.xlsm", False)
        Catch ex As Exception
            objLog.toWrite(C_NOMBRE_APLICATIVO, GCC.Entity.EConstante.C_AMBIENTE_PRODUCCION, "Reporte Compras", "", "", 0, "", ex.Message, "", "")
            objLog.escribe("FATAL", "Excepcion : " & ex.Message, "Page_Load")
            GCCUtilitario.ShowError("ERROR => " + ex.Message, Me)
            Throw ex
        End Try
