<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRepRetencionCuarta.aspx.vb"
    Inherits="Reportes_frmRepRetencionCuarta" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="../Reportes/frmRepRetencionCuarta.aspx.js"> </script>
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">
                        Reporte Retención 4ta Categoria</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
