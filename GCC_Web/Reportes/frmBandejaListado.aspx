<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBandejaListado.aspx.vb" Inherits="Reportes_frmBandejaListado" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmBandejaListado.aspx.js"> </script>
	
</head>
<body>
    <form id="frmBandejaListado" runat="server">
	    ...
	    <table id="tb_cuerpoCabecera" style="border: 0;" cellpadding="0" cellspacing="0">
		    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo" id="lbl_titulo">Reportes :: Listado</div>
			    </td>
			    <td class="espacio">
			        &nbsp;    								
			    </td>
			    <td class="botones">				  			
				    <div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_buscarContratoCotizacion(true);">
						    <img alt="" src="../Util/images/ico_acc_buscar.gif" style="border: 0;" /><br />
						    Buscar
					    </a>
				    </div>	
				    ...
				    <div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_Limpiar();">
						    <img alt="" src="../Util/images/ico_acc_limpiar.gif" style="border: 0;" /><br />
						    Limpiar
					    </a>
				    </div>	
				    ...
				    <div id="dv_img_boton" class="dv_img_boton" style="width:100px;">
					    <a href="javascript:fn_VerContrato();">
						    <img alt="" src="../Util/images/ico_acc_ver.gif" style="border: 0;" title="Ver Contrato" /><br />
						    Ver Contrato
					    </a>
				    </div>
				    
				    <div id="dv_img_boton" class="dv_img_boton" style="width:100px;">
					    <a href="javascript:fn_VerCotizacion();">
						    <img alt="" src="../Util/images/ico_acc_ver.gif" style="border: 0;" title="Ver Cotización" /><br />
						    Ver Cotización
					    </a>
				    </div>
				    
				    <div id="dv_img_boton" class="dv_img_boton" style="width:110px;">
					    <a href="javascript:fn_abreSeguimientoGlobal();">
						    <img alt="" src="../Util/images/ico_seguimiento.gif" style="border: 0;" title="Seguimiento Contrato" /><br />
						    Seguimiento
					    </a>
				    </div>
				        ...
				        <div id="dv_datos" class="dv_tabla_contenedora">        					
					        <table id="tb_formulario" style="border: 0;" cellpadding="0" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    <td class="input">
                                        <select id="cmbZonalCombo" name="cmbZonalCombo" runat="server">
                                        </select>
                                    </td>    
                                    <td class="label">Fecha Final</td>  
                                    <td class="input">
                                        <input id="txtFechaFin"  name="txtFechaFin" type="text" class="css_input" size="11" runat="server" />
                                    </td> 
                                </tr>
                            </table>        					
				        </div>        		
