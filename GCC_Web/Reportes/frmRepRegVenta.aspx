<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRepRegVenta.aspx.vb"
    Inherits="Reportes_frmRepRegVenta" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="../Reportes/frmRepRegVenta.aspx.js"> </script>
        ...
        <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                ...
                <td class="botones">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton" style="width: 60px;">
                        <a href="javascript:fn_retencionPDT();">
