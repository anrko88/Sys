...
function fn_Reporte() {
    ...
    if ((strFechaActIni == '') && (strFechaActFin != '')) { strMensaje = strMensaje + '- Ingrese fecha de activación desde<br/>'; }
    if ((strFechaActIni != '') && (strFechaActFin == '')) { strMensaje = strMensaje + '- Ingrese fecha de activación hasta<br/>'; }
