<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmNotasAbono.aspx.vb" Inherits="Reportes_frmNotasAbono" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="../Reportes/frmNotasAbono.aspx.js"> </script>
            ...
            <tr>
                ...
                <td class="botones">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton" style="width: 60px;">
                        <a href="javascript:fn_reporteAbonos();">
