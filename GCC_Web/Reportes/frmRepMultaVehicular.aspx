<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRepMultaVehicular.aspx.vb"
    Inherits="Reportes_frmRepMultaVehicular" %>
...
<body>
    ...
    <table id="tblReporte" border="0" cellpadding="0" cellspacing="0" style="width: 100%;"
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblTitle" Text="Multa Vehicular" runat="server" Font-Size="Small"
