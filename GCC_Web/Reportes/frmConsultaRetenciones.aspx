<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConsultaRetenciones.aspx.vb"
    Inherits="Reportes_frmConsultaRetenciones" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="../Reportes/frmConsultaRetenciones.aspx.js"> </script>
...
<body>
    ...
    <div style="display: none">
        ...
        <asp:Button ID="btnGenerarSunat" runat="server" />
    </div>
    </form>
</body>
</html>
