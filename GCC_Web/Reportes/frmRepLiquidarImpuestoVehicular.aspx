<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRepLiquidarImpuestoVehicular.aspx.vb" Inherits="Reportes_frmRepLiquidarImpuestoVehicular" %>
            ...
            <tr>
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td style="font-weight:bold;color:black">Nº Lote: &nbsp; <asp:Label ID="txtLote" runat="server" /></td>
                                
                                <td style="font-weight:bold;color:black">Total: &nbsp; <asp:Label ID="txtTotal" runat="server" /></td>
