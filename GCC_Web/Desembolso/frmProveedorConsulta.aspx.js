...
function fn_cargaGrilla() {	
  $("#jqGrid_lista_A").jqGrid({
	...
	colModel:[ 
		...
		{name: 'razonsocial', index: 'razonsocial', width: 200, align: "left", sorttype: "string"},
		{name: 'TipoDePersona', index: 'TipoDePersona', width: 110, align: "center", sorttype: "string"},
		...
		{name: 'chek', index: 'chek', width: 25, align: "center", formatter: AddProveedor}
  ...
  function AddProveedor(cellvalue, options, rowObject) {
        return "<img src='../Util/images/ok.gif' alt='" + cellvalue + "' title='Agregar proveedor(es)' width='20px' />";
  };
  var mydata = [ 
		...
		{ruc: "98746541541", razonsocial: "ZAMORA FLORES ALCALA", TipoDePersona: "Persona Natural", Procedencia: "Local", Contacto: "ARGUEDAS HUAMAN GLORIA SOLEDAD", Correo: "", chek: ""},
		{ruc: "98765463111", razonsocial: "COMPAÑIAS UNIDAS VITARTE VICTORIA INCA", TipoDePersona: "Persona Jurídica", Procedencia: "Local",Contacto: "BUENO MENDOZA GAMIO CARLOS", Correo:"", chek: ""}
  ]; 
  for(var i = 0; i <= mydata.length; i++) 
	jQuery("#jqGrid_lista_A").jqGrid('addRowData', i + 1, mydata[i]);
}

function fn_AgregaProveedor() {
    var sTitulo = "";
    
    sTitulo = "LISTA :: PROVEEDORES";    
    fn_util_AbreModal(sTitulo, "frmProveedorAgregar.aspx", 900, 525, function(){} );
}