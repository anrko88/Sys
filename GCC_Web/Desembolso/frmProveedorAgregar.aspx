<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProveedorAgregar.aspx.vb" Inherits="Desembolso_frmProveedorAgregar" %>
...
<head runat="server">
   <title>GCC :: Sistema de Gestión de Leasing</title>
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmProveedorAgregar.aspx.js"></script>
</head>
<body>
     <form id="frmProveedorAgregar" runat="server">
		    ...
		    <tr>
			    ...
			    <td class="botones">
				    ...
				    <div id="dv_img_boton" class="dv_img_boton" style="width:95px;">
					    <a href="javascript:parent.fn_util_CierraModal();">
						    <img alt="" src="../Util/images/ico_acc_grabar.gif" border="0" title="Limpiar" /><br />
						    Guardar
					    </a>
				    </div>
