<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmLineaDetalle.aspx.vb" Inherits="Comun_frmLineaDetalle" %>
    ...
    <form id="frmCotizacionLineaDetalle" runat="server">
        ...
        <table id="tb_formulario" border="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="input"><input id="txtMontoDisponible" name="txtMontoDisponible" type="text" class="css_input" size="11"/></td>
            <td class="label">Monto Aprobado</td>
            <td class="input"><input id="txtMontoAprobado" name="txtMontoAprobado" type="text" class="css_input" size="11"/></td>
          </tr>
          <tr>
            <td class="label">Monto Utilizado</td>
            <td class="input"><input id="txtMontoUtilizado" name="txtMontoUtilizado" type="text" class="css_input" size="11"/></td>
          ...
          <tr>
            ...
            <td class="input"><input id="txtFechaAprobacion" type="text" class="css_input" value="" size="11"/></td>
            <td class="label">Fecha Vencimiento</td>
            <td class="input"><input id="txtFechaVence" type="text" class="css_input" size="11"/></td>
          </tr>
          </table>
      </div>
    </form>
