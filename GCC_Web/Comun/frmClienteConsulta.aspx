<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmClienteConsulta.aspx.vb" 
Inherits="Comun_frmClienteConsulta" %>
...
<head runat="server">
    ...
    <script type='text/javascript' src="frmClienteConsulta.aspx.js"></script>
</head>
<body>
    <form id="frmClienteConsulta" runat="server">
    <div id="dv_cuerpo">
        ...
        <div id="dv_contenedor" class="css_scrollPane">
            ...
            <input id="hddCodigoCliente" name="hddCodigoCliente" type="hidden" />
        <!-- Fin Cuerpo -->
    </div>
    </form>
</body>
