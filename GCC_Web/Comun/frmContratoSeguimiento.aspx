<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmContratoSeguimiento.aspx.vb" Inherits="Comun_frmContratoSeguimiento" %>
...
<!-- Icono URL -->
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmContratoSeguimiento.aspx.js"></script>
...
<body>
    <form id="frmContratoSeguimiento" runat="server">
        ...
        <div id="dv_cuerpoModal">
    	    ...
    	    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo">Devolver Documento</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
        ...
        <input type="hidden" name="hddCodigoEstadoContrato" id="hddCodigoEstadoContrato" value="" runat="server" />
