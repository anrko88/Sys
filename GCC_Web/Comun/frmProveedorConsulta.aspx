<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmProveedorConsulta.aspx.vb"
    Inherits="Comun_frmProveedorConsulta" %>
...
<body>
    ...
    <div id="dv_cuerpo">
            ...
            <tr>
                ...
                <td class="titulos">
                    <div class="css_lbl_subTitulo">
                        Gestión Proveedor</div>
                    <div class="css_lbl_titulo">
                        Proveedor :: Búsqueda</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
        ...
        <div id="dv_contenedor" class="css_scrollPane">
            ...
            <input id="hddCodigoProveedor" name="hddCodigoProveedor" type="hidden" />
        <!-- Fin Cuerpo -->
    </div>
    </form>
</body>
