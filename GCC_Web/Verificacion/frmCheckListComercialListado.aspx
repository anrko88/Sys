<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCheckListComercialListado.aspx.vb" Inherits="Verificacion_frmCheckListComercialListado" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmCheckListComercialListado.aspx.js"> </script>
	
</head>
<body>
    
<form id="frmCotizacionChecklistListado" runat="server">
	    ...
	    <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
		    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo" id="lbl_titulo">CheckList Comercial ::  Listado</div>
			    </td>
			    <td class="espacio">
			        &nbsp;    								
			    </td>
