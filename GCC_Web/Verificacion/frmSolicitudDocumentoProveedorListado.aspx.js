...
function fn_cargaGrilla() {
    $("#jqGrid_lista_A").jqGrid({
        ...
        ondblClickRow: function(id) {
            parent.fn_blockUI();
            var rowData = $("#jqGrid_lista_A").jqGrid('getRowData', id);
            window.location = "frmSolicitudDocumentoProveedorRegistro.aspx?cc=" + rowData.CODSOLICITUDCREDITO;
        }
    });
...
function fn_ListarContratoCotizacion() {
    ...
    fn_util_AjaxWM("frmSolicitudDocumentoProveedorListado.aspx/ListadoContratoCotizacion",
                   arrParametros,
                   function(jsondata) {
...
function fn_Editar() {
    ...
    if (strId == "" || strId == null || strId == undefined) {
        ...
        window.location = "frmSolicitudDocumentoProveedorRegistro.aspx?cc=" + strId;
    }
}