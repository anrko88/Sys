...
//***********************************************************************
// Funcion		:: 	JQUERY - Verificacion Listado Solucitud de Documento Cliente
...
function fn_Limpiar() {
    ...
    $("#cmbZonal option").eq("0").attr("selected", "selected");
...
function fn_cargaGrilla() {
    $("#jqGrid_lista_A").jqGrid({
        ...
        ondblClickRow: function(id) {
            parent.fn_blockUI();
            var rowData = $("#jqGrid_lista_A").jqGrid('getRowData', id);
            window.location = "frmSolicitudDocumentoClienteRegistro.aspx?cc=" + rowData.CODSOLICITUDCREDITO;
        }
    });
...
function fn_ListarContratoCotizacion() {
    ...
    var arrParametros = ["pPageSize", fn_util_getJQGridParam("jqGrid_lista_A", "rowNum"),
                         ...
                         "pClasifBien", $("#cmbClasificacionbien").val(),
                         "pZonal", $("#cmbZonal").val(),
                         "pFechaInicio", $("#txtFechaIni").val(),
                         "pFechaFin", $("#txtFechaFin").val()
                         ];
    
    fn_util_AjaxWM("frmSolicitudDocumentoClienteListado.aspx/ListadoContratoCotizacion",
                   arrParametros,
                   function(jsondata) {
...
function fn_Editar() {
    ...
    if (strId == "" || strId == null || strId == undefined) {
        ...
        parent.fn_blockUI();
        window.location = "frmSolicitudDocumentoClienteRegistro.aspx?cc=" + strId;
    }
}