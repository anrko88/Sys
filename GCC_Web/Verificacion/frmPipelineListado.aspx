<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPipelineListado.aspx.vb" Inherits="Verificacion_frmPipelineListado" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmPipelineListado.aspx.js"> </script>
...
<form id="frmPipeline" runat="server">
    ...
    <div id="dv_cuerpo">    	
	    <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
		    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo" id="lbl_titulo">Pipeline :: Listado</div>
			    </td>
			    <td class="espacio">
			        &nbsp;    								
			    </td>
				    ...
				    <div id="dv_img_boton" class="dv_img_boton">
				       ...
				       <div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_Reporte();">
						    <img alt="" src="../Util/images/ico_acc_importar.gif" border="0" title="Exportar" /><br />
						    Exportar
					    </a>
				    </div>
				       <div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_Actualizar();">
						    <img alt="" src="../Util/images/ico_acc_actualizar.gif" border="0" title="Actualizar" height="35px" width="35px" /><br />
						    Actualizar
					    </a>
				    </div> 	
    	...
    	<div id="dv_contenedor" class="css_scrollPane" >
				        ...
				        <div id="dv_datos" class="dv_tabla_contenedora">
					        ...
					        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                <tr>
                                    ...
                                    <td class="input">
                                        <input id="txtRazonsocial" name="txtRazonsocial" type="text" class="css_input" size="40" runat="server"  />
                                    </td>
                                    <td class="label">
                                        Ejecutivo
                                    </td>
            ...
            <asp:HiddenField id="HddSelected" runat="server"/>
            <asp:HiddenField ID="hidAcumuladoCodCotizacion" runat="server" />
            <!-- Inicio IBK - AAE -->
            <div style="display: none">                
                <asp:Button ID="btnGenerar" runat="server" />
                <asp:Button ID="btnGenerar2" runat="server" />
            </div>
            <!-- Fin IBK - AAE -->
	    </div>    	
    </div>
