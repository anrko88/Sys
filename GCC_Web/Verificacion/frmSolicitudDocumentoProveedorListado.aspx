<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSolicitudDocumentoProveedorListado.aspx.vb" Inherits="Verificacion_frmSolicitudDocumentoProveedorListado" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmSolicitudDocumentoProveedorListado.aspx.js"> </script>
	
</head>
<body>
    
<form id="frmSolicitudDocumentoProveedorListado" runat="server">
	    ...
	    <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
		    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo" id="lbl_titulo">Proveedor :: Listado</div>
			    </td>
			    <td class="espacio">
			        &nbsp;    								
			    </td>
				        ...
				        <div id="dv_datos" class="dv_tabla_contenedora">
					        ...
					        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                <tr>
                                    ...
                                    <td class="input">
                                        <input id="txtNroCotizacion" name="txtNroCotizacion" type="text" class="css_input" runat="server" /></td>
                                    <td class="label">CU Cliente</td>
                                    <td class="input">
                                        <input id="txtCuCliente" name="txtCuCliente" type="text" class="css_input" runat="server" /></td>
