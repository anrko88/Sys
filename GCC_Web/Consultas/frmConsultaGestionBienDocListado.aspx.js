...
function fn_GBListarDocumentos() {
    ...
    try {        
        ...
        fn_util_AjaxWM("frmConsultaGestionBienDocListado.aspx/ListadoDocumentos",
                arrParametros,
                function(jsondata) {
...
//	
//	fn_util_globalRedirect("/Consultas/frmConsultaGestionBienDocRegistro.aspx"+strParametros);
//}
