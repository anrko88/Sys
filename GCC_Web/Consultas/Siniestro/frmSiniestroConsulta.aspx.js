...
function fn_cancelar() {
    ...
    parent.fn_mdl_confirma(
                    ...
                    function() {
                        fn_util_globalRedirect("/Consultas/Siniestro/frmSiniestroListadoConsulta.aspx");
                    },
...
function fn_buscaSiniestro() {
    try {
        ...
        fn_util_AjaxWM("frmSiniestroConsulta.aspx/ListaSiniestro",
                arrParametros,
                function(jsondata) {
...
function fn_verSiniestro() {
    ...
    if (fn_util_trim(codSiniestro) == "") {
        ...
        parent.fn_util_AbreModal("Consultas :: Siniestro", "Consultas/Siniestro/frmSiniestroVer.aspx?hddCodContrato=" + $("#hddCodContrato").val() + "&hddCodBien=" + $("#hddCodBien").val() + "&hddCodSiniestro=" + $("#hddCodSiniestro").val() + "&hddVer=1", 950, 500, function() { });
    }
}
