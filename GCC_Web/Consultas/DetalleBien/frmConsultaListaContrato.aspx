<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConsultaListaContrato.aspx.vb" 
    Inherits="Consultas_frmConsultaListaContrato" %>
...
<head runat="server">
    ...
    <script src="frmConsultaListaContrato.aspx.js" type="text/javascript"></script>
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo" style="width: 400px">
                         Detalle del Bien   ::   Búsqueda por Contrato</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
