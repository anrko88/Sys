...
//var mydata = 
//          [
//		    { CodSolicitudCredito: "10000001", CodUnico: " 0000000987", RazonSocial: "RIPLEY", ClasificacionBien: "Unidades de transporte terrestre Livianos", TipoBien: "Automóvil", EstadoContrato: "Formalizado", CantidadProducto: "5",TipoDocumento: "RUC",NumeroDocumento: "20451254121",codOpcionCompra: "Total",SecFinanciamiento: "1"},
//            { CodSolicitudCredito: "10000002", CodUnico: " 0000000986", RazonSocial: "RIPLEY", ClasificacionBien: "Unidades de Transporte terrestre Pesados", TipoBien: "Camión", EstadoContrato: "Formalizado", CantidadProducto: "10",TipoDocumento: "RUC",NumeroDocumento: "20451254121",codOpcionCompra: "Total",SecFinanciamiento: "1"},
//          	{ CodSolicitudCredito: "10000003", CodUnico: " 0000000985", RazonSocial: "RIPLEY", ClasificacionBien: "Maquinaria y Equipos Industrial", TipoBien: "Maquinaria Textil", EstadoContrato: "Formalizado", CantidadProducto: "1",TipoDocumento: "RUC",NumeroDocumento: "20451254121",codOpcionCompra: "Parcial",SecFinanciamiento: "2"},
//          	{ CodSolicitudCredito: "10000004", CodUnico: " 0000000984", RazonSocial: "RIPLEY", ClasificacionBien: "Sistema de procesamiento electrónico de datos", TipoBien: "Computadoras", EstadoContrato: "Formalizado", CantidadProducto: "3",TipoDocumento: "RUC",NumeroDocumento: "20451254121",codOpcionCompra: "Parcial",SecFinanciamiento: "3"},
//          	{ CodSolicitudCredito: "10000005", CodUnico: " 0000000983", RazonSocial: "RIPLEY", ClasificacionBien: "Bienes Inmuebles", TipoBien: "Embarcaciones", EstadoContrato: "Formalizado", CantidadProducto: "15",TipoDocumento: "RUC",NumeroDocumento: "20451254121",codOpcionCompra: "No Ejercida",SecFinanciamiento: "4"},
//          	{ CodSolicitudCredito: "10000006", CodUnico: " 0000000981", RazonSocial: "RIPLEY", ClasificacionBien: "Bienes Inmuebles", TipoBien: "Embarcaciones", EstadoContrato: "Formalizado", CantidadProducto: "8",TipoDocumento: "RUC",NumeroDocumento: "20451254121",codOpcionCompra: "No Ejercida",SecFinanciamiento: "4"}
...
//    	   datatype: "local",
        ...
        colNames: ['Nº Contrato', 'CU Cliente','Razón Social o Nombre','Tipo de Documento','Nº Documento','Clasificación del Bien','Tipo de Bien','Estado del Contrato','Opción de Compra','','',''],
        colModel: [
        ...
        ondblClickRow: function() {
            parent.fn_blockUI();
            fn_util_redirect('frmConsultasBienContrato.aspx?co=1&csc=' + $("#hidCodigoSolicitudCredito").val());
        	}
    });
...
function fn_buscarContrato() {
    ...
    fn_util_AjaxWM("frmConsultaListaContrato.aspx/BuscarContrato",
                    arrParametros,
                    function(jsondata) {
...
//****************************************************************
function fn_Editar() {
    if (($("#hidCodigoSolicitudCredito").val() != '')) {
        fn_util_redirect('frmConsultasBienContrato.aspx?csc=' + $("#hidCodigoSolicitudCredito").val());
    } else {
...
function fn_Limpiar() {
	...
	$('#ddlTipobien').html(strComboVacio);
	$("#ddlTipobien").val(0);
