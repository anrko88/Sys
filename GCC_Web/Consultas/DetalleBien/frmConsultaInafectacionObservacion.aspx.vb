...
Partial Class Consultas_frmConsultaInafectacionObservacion
    Inherits System.Web.UI.Page

    Dim objLog As New GCCLog("frmConsultaInafectacionObservacion.aspx.vb")
    ReadOnly Titulo As String = "Consultas"
#Region "Eventos"
