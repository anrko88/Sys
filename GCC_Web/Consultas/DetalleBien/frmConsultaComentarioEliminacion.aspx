<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConsultaComentarioEliminacion.aspx.vb" Inherits="Consultas_frmConsultaComentarioEliminacion" %>
...
<!-- Icono URL -->
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmConsultaComentarioEliminacion.aspx.js"></script>
    ...
    <form id="frmContratoSeguimiento" runat="server">
        ...
        <table id="tb_formulario" border="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="input" runat="server" id="txtFecha">
                <%--<input id="txtFecha" name="txtFecha" type="text" class="css_input_inactivo" disabled="disabled" size="11" runat="server"/>--%>
          ...
          <tr>
            ...
            <td class="input">
                <textarea name="txtComentario" id="txtComentario" cols="75" rows="6" class="css_input_inactivo" disabled="disabled" readonly="readonly" runat="server"></textarea>
            </td>
          </tr>
