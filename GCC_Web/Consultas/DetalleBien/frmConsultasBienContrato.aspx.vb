...
Partial Class Consultas_frmConsultasBienContrato
    Inherits GCCBase
    Dim objLog As New GCCLog("frmConsultasBienContrato.aspx.vb")
...
#Region "Métodos"
    Private Sub pInicializarControles()
        ...
        Try
            oESolicitudCreditoEstructura = GCCUtilitario.DeserializeObject(Of ESolicitudcreditoestructura)(oLwsDocBienNtx.ObtenerDatosBienContratoConsulta(hidNumeroContrato.Value))
