...
//IBK - RPH agrego la columna Id para obtenerlo en el paginado cuando no se seleccione
    ...
    $("#jqGrid_lista_A").jqGrid({
        ...
        ondblClickRow: function(id) {
            ...
            fn_util_redirect('frmConsultasBienDetalle.aspx?co=1&csc=' + $('#hidNumeroContrato').val() + '&csf=' + $("#hidSecFinanciamiento").val() + '&flag=' + $("#hidFlagOrigen").val() + '&codestado=' + $("#hidCodEstado").val() + "&precioventa=" + $("#hidPrecioVenta").val());
            //fin
        }
...
function VerObservaciones(strcodContrato,strsecfinanciamiento) {
    ...
    var sSubTitulo = "Consultas :: Observación de Baja  ";
    parent.fn_util_AbreModal(sSubTitulo, "Consultas/DetalleBien/frmConsultaComentarioEliminacion.aspx?ccf=" + strcodContrato + "&csf=" + strsecfinanciamiento + "&Add=true", 500, 250, function() { });
}
...
function fn_buscarInmuebles() {
	    $("#hddRowId").val('');
	    var vNumeroContrato = $('#txtNumeroContrato').html() == undefined ? "" : $('#txtNumeroContrato').html();
    ...
    fn_util_AjaxWM("frmConsultasBienContrato.aspx/ListaBienContratoInmuebles",
                    arrParametros,
                    function(jsondata) {
...
function fn_buscarMaquinarias() {
    ...
    fn_util_AjaxWM("frmConsultasBienContrato.aspx/ListadoBienContratoMaquinaria",
                    arrParametros,
                    function(jsondata) {
...
function ListaBienContratoVehiculos() {
    ...
    fn_util_AjaxWM("frmConsultasBienContrato.aspx/ListaBienContratoVehiculos",
                    arrParametros,
                    function(jsondata) {
...
function fn_buscarSistemasOtros() {
    ...
    fn_util_AjaxWM("frmConsultasBienContrato.aspx/ListadoBienContratoSistemas",
                    arrParametros,
                    function(jsondata) {
...
function VerObservacionesDocumento(strcodContrato,strsecfinanciamiento,strobservacion,strnombrearchivo) {
    var sTitulo = "Gestión del Bien";
    var sSubTitulo = "Consultas :: Observación de Documento";
...
function fn_ListagrillaDocumentos() {
    ...
    fn_util_AjaxSyncWM("frmConsultasBienContrato.aspx/ListaDocumentos",
    arrParametros,
    function(jsondata) {
...
function fn_cancelar() {
	fn_mdl_confirma('¿Está seguro de volver?',
		function() {
			parent.fn_blockUI();
			fn_util_redirect('frmConsultaListaContrato.aspx');
		},
...
function fn_abreNuevoDocumentoComentario() {
        ...
        parent.fn_util_AbreModal("Consultas :: Documentos y Comentarios", "Consultas/DetalleBien/frmConsultaDocumentoBienContrato.aspx?codcontrato=" + strCodigoContrato, 650, 320, function() { });
...
function fn_abreEditarDocumentoComentarioMaquina() {
    ...
    if (IsNullOrEmpty(id)) {
        ...
        parent.fn_util_AbreModal("Consultas :: Documentos y Comentarios", "Consultas/DetalleBien/frmConsultaDocumentoBienContrato.aspx?codcontrato=" + strCodigoContrato + "&codigo=" + codigo + "&obs=" + strobservacion + "&nomArchivo=" + strnombrearchivo + "&det=" + strEstadoBien, 650, 320, function() { });
    }
...
function fn_abreEditarDocumentoComentario() {
	    ...
	    if(IsNullOrEmpty(id)) 
	    {
	    parent.fn_mdl_mensajeIco("Seleccione un registro para poder editar.", "util/images/warning.gif", "Consultas");	
	    }else 
	    {
		var rowData = $("#jqGrid_lista_I").jqGrid('getRowData', id);
		var codigo = rowData.CODIGOBIENDOCUMENTO;
...
//	parent.fn_mdl_mensajeIco("Seleccione un registro para poder agregar.", "util/images/warning.gif", "Consultas");	
//	}else 
//	{
...
//            parent.fn_mdl_mensajeIco("Seleccione un sólo registro.", "util/images/warning.gif", "Consultas");
//        } else {
...
//			{
		...
		var rowData = $("#jqGrid_lista_A").jqGrid('getRowData', id);
		//window.location = "frmConsultasBienDetalle.aspx?co=1&csc=" + rowData.CodSolicitudCredito + "&csf=" + rowData.SecFinanciamiento + "&flag=" + rowData.FlagOrigen  + "&codestado=" + rowData.CodEstadoBien;
		window.location = "frmConsultasBienDetalle.aspx?co=1&csc=" + rowData.CodSolicitudCredito + "&csf=" + rowData.SecFinanciamiento + "&flag=" + rowData.FlagOrigen + "&codestado=" + rowData.CodEstadoBien + "&precioventa=" + sPrecioVenta;
//			}else{
//			parent.fn_mdl_mensajeIco("Seleccione un registro para poder editar.", "util/images/warning.gif", "Consultas");
//            }
        }
...
function fn_EditarVehiculos() {
    ...
    if ($("#jqGrid_lista_C").getGridParam("reccount") == 0) 
	{
	    ...
	    */
	    ...
	    var rowData = $("#jqGrid_lista_C").jqGrid('getRowData', id);
	    window.location = "frmConsultasBienDetalle.aspx?co=1&csc=" + rowData.CodSolicitudCredito + "&csf=" + rowData.SecFinanciamiento + "&flag=" + rowData.FlagOrigen + "&codestado=" + rowData.CodEstadoBien + "&precioventa=" + sPrecioVenta;
	    //window.location = "frmConsultasBienDetalle.aspx?co=1&csc=" + rowData.CodSolicitudCredito + "&csf=" + rowData.SecFinanciamiento + "&flag=" + rowData.FlagOrigen + "&codestado=" + rowData.CodEstadoBien + "&precioventa=" + sPrecioVenta + "&total=" + total;
