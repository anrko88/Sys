<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConsultaInscripcionMunicipalDetalle.aspx.vb" Inherits="Consultas_frmConsultaInscripcionMunicipalDetalle" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmConsultaInscripcionMunicipalDetalle.aspx.js"></script>
...
<body>
    <form id="frmMotivoRechazo" runat="server">
    	    ...
    	    <tr>
			    <td class="icono">
                    <asp:Image ID="Image1" runat="server" 
                        ImageUrl="~/Util/images/ico_mdl_mantenimiento.jpg" />
                </td>
			    <td class="titulos">
				    <div class="css_lbl_subTitulo">Consultas</div>
				    <div class="css_lbl_titulo">Inscripción Municipal</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
	    ...
	    <input type="hidden" id="hidResultado" name="hidResultado" value="NUEVO" runat="server" />
	   ...
	   <table id="tb_formulario" border="0" cellpadding="0">
           <tr>
            ...
            <td class="input" id="txtPartidaRegistral" runat="server">
                <%--<input id="txtPartidaRegistral" type="text" class="css_input"  runat="server"/>--%>
            </td>
             <td class="label">
                Asiento Registral
            </td>
            <td class="input" runat="server" id="txtAsientoRegitral" >
               <%-- <input id="txtAsientoRegitral" type="text" class="css_input"  runat="server"/>--%>
            </td>
          </tr>
          <tr>
           <td class="label">
            ...
            <td class="input" id="txtActo" runat="server" >
                <%--<input id="txtActo" type="text" class="css_input"  runat="server"/>--%>
            </td>
          </tr>
