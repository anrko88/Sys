<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConsultaImpuestoVehicularRegistro.aspx.vb" Inherits="Consultas_ImpuestoVehicular_frmConsultaImpuestoVehicularRegistro" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmConsultaImpuestoVehicularRegistro.aspx.js"> </script>

</head>
<body>
    <form id="frmConsultaImpuestoVehicularRegistro" runat="server">
    <!-- **************************************************************************************** -->
    <!-- CUERPO -->
    <!-- **************************************************************************************** -->
            ...
            <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="cuerpo">
                        ...
                        <input id="btnCargarImpuesto" type="button" value="button" runat="server" style="display: none" onclick="javascript:fn_ListarImpuestosLote();" />
