<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmConsultasImpuestoVehicular.aspx.vb" Inherits="Consultas_ImpuestoVehicular_frmConsultasImpuestoVehicular" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmConsultasImpuestoVehicular.aspx.js"> </script>
        ...
        <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">Impuesto Vehicular :: Listado</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                <td class="botones" style="height:60px;vertical-align:top;">
                    ...
                    <%--<div id="dv_img_boton" class="dv_img_boton" style="width:60px;">
                        <a href="javascript:fn_abreCargarArchivo();">
            ...
            <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="cuerpo">
                        ...
                        <input id="btnCargarImpuesto" type="button" value="button" runat="server" style="display: none" onclick="javascript:fn_ListarImpuesto();" />
                        ...
                        <div class="dv_tabla_contenedora">
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    <td class="input">
                                       <input id="txtNroLote" type="text" class="css_input" />   
                                    </td>
                                    <td class="label">
                                       Año Fabricación 
                                    </td>
                                    <td class="input">
                                        <input id="txtAnioFabricacion" type="text" class="css_input" />  
                                    </td>
                                    <td class="label">
                                        Periodo
                                    </td>
                                    <td class="input">
                                       <input id="txtPeriodo" type="text" class="css_input" />   
                                    </td>
                                </tr>  
                                  <tr>
                                    <td class="label">
                                    ...
                                    <td class="input">
                                       <input id="txtFechaInscripcionDesde" type="text" class="css_input" />   
                                    </td>
                                    <td class="label">
                                       F. Inscripción Registral Hasta 
                                    </td>
                                    <td class="input">
                                        <input id="txtFechaInscripcionHasta" type="text" class="css_input" />  
                                    </td>
                                    <td class="label">
                                        Estado Pago
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="input"><select id="ddlEstadoCobro" runat="server" name="ddlEstadoCobro">
                                            <option value='0'>[-Seleccione-]</option>
                                        </select></td>
                                </tr>                              
                            </table>                                                      
