<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmMultaVehicularListadoConsulta.aspx.vb"
    Inherits="Consultas_MultaVehicular_frmMultaVehicularListadoConsulta" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmMultaVehicularListadoConsulta.aspx.js"> </script>


</head>
<body>

<form id="frmMultaVehicularListadoConsulta" runat="server">
<!-- **************************************************************************************** -->
<!-- CUERPO -->
<!-- **************************************************************************************** -->
<div id="dv_cuerpo">
        ...
        <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="lineas">
                    ...
                    <asp:hiddenfield id="hidMunicipalidad" runat="server" value="0" />
                </td>
            </tr>
            <tr>
                <td class="cuerpo">
                    ...
                    <div class="dv_tabla_contenedora">
                        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                            ...
                            <tr>
                                ...
                                <td class="input">
                                    <select id="ddlTipoBien" runat="server" name="ddlTipoBien" onchange="fn_SetearTipo(this.value,0);">
                                        <option value='0'>[-Seleccione-]</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="input">
                                    <select id="ddlMunicipalidad" runat="server" name="ddlMunicipalidad" onchange="fn_SetearTipo(this.value,1);">
                                        <option value='0'>[-Seleccione-]</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="input">
                                    ...
                                    -
                                    <input id="txtCodigoInfraccion" type="text" runat="server" class="css_input" style="width: 45px" />
                                </td>
                                <td class="label">
                                    Estado Pago
                                </td>
