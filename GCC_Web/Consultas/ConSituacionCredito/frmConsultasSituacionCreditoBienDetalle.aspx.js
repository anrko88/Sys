...
function fn_Volver() {
 	...
 	fn_mdl_confirma('¿Está seguro de volver?',
		function() {
			parent.fn_blockUI();
        fn_util_redirect('frmConsultaSituacionCreditoRegistro.aspx?co=1&hddCodigo=' + $("#txtNumeroContrato").html());
		},
...
function fn_Back() {
    ...
    if ($("#hidSecFinanciamiento").val() == '2') {
        ...
        fn_util_redirect('frmConsultasSituacionCreditoBienDetalle.aspx?co=1&csc=' + $('#hidNumeroContrato').val() + '&csf=' + objinthidSecFinanciamiento + '&flag=' + $("#hidFlagOrigen").val() + '&codestado=' + $("#HidCodEstado").val() + "&precioventa=" + $("#hidPrecioVenta").val());
    }
}
function fn_Next() {
    var objinthidSecFinanciamiento = $("#hidSecFinanciamiento").val();
