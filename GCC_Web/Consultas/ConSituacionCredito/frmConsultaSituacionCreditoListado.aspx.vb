...
Partial Class ConSituacionCredito_frmConsultaSituacionCreditoListado
    Inherits GCCBase
...
#Region "Métodos"
    ...
    Private Sub InicializarListas()
        ...
        GCCUtilitario.CargarComboValorGenerico(Me.cmbEstado, GCCConstante.C_TABLAGENERICA_ESTADO_OPERACIONACTIVA)
    ...
    Public Shared Function BuscarContratos(ByVal pPageSize As Integer, _
                                           ...
                                           ByVal pEstadoOperacionActiva As String) As JQGridJsonResponse
        Dim objContratoNTx As New LContratoNTx

        Dim dtContrato As DataTable = GCCUtilitario.DeserializeObject(Of DataTable)(objContratoNTx.ListadoContratos2(pPageSize, _
                                                                                                                    pCurrentPage, _
                                                                                                                    pSortColumn, _
                                                                                                                    pSortOrder, _
                                                                                                                    pContrato, _
