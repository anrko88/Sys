<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSituacionObservacion.aspx.vb"
    Inherits="SituacionCredito_frmSituacionObservacion" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmSituacionObservacion.aspx.js"> </script>
    ...
    <div id="dv_cuerpoModal">
        ...
        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="input">
                    <textarea id="TxaObs" name="TxaObs" rows="4" cols="20" style="width: 500px" runat="server" disabled="disabled" readonly="readonly"></textarea>
                </td>
