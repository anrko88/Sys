...
function fn_configuraGrilla() {
    $("#jqGrid_lista_A").jqGrid({
        ...
        ondblClickRow: function(id) {
            ...
            var rowData = $("#jqGrid_lista_A").jqGrid('getRowData', id);
            window.location = "frmSituacionCreditoRegistro.aspx?pTipoTransaccion=EDITAR&hddCodigo=" + rowData.CodSolicitudCredito;
        }
    });
...
function fn_abreDetalle() {
    try {
        ...
        if (strId == "" || strId == null || strId == undefined) {
            ...
            fn_util_redirect("frmSituacionCreditoRegistro.aspx?pTipoTransaccion=EDITAR&hddCodigo=" + strId);
        }
    } catch (ex) {
...
function fn_buscarListarContratos() {
    ...
    try {
        ...
        if (fn_ValidarDatos()) {
            ...
            fn_util_AjaxWM("frmSituacionCreditoListado.aspx/BuscarContratos",
                           arrParametros,
                           function(jsondata) {
