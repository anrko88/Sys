...
function fn_llenaGrillaCronograma() {
    ...
    try {
        ...
        fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/ListadoCotizacionCronograma",
                arrParametros,
                function(jsondata) {
...
function fn_paginaCronograma() {
    ...
    try {
        ...
        fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/PaginaCronograma",
                arrParametros,
                function(jsondata) {
                    jqGrid_lista_L.addJSONData(jsondata);                    
                    fn_doResize();
...
function fn_ListaBienesDatosInmueble() {
    ...
    fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/ListarBienes",
                        arrParametros,
                        function(jsondata) {
...
function fn_ListaBienesDatosMaquina() {
    var arrParametros = [
                         ...
                         "pContrato", $('#hddCodigoContrato').val(),
                         "pFields", "CantidadProducto|SecFinanciamiento|Comentario|CodigoEstadoBien|EstadoBien|Ubicacion|NroSerie|Marca|NroMotor|Anio|Modelo|Carroceria|Placa|Medidas|Uso|Departamento|Provincia|Distrito|DepartamentoNombre|ProvinciaNombre|DistritoNombre"
                         ];
...
function ConfigurarGrillaInmueble() {
    ...
    $("#jqGrid_lista_A").jqGrid({
        ...
        colModel: [
                ...
                { name: 'DistritoNombre', index: 'DistritoNombre', hidden: true },
...
function fn_GuardarMaquinaNuevo() {
    ...
    if (EsValidoMaquina()) {
        ...
        fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarMaquinaNuevo",
                       arrParametros,
                       function() {
                            $("#hddFlagModificado").val("1");
...
function ConfigurarGrillaMaquinaria() {
    ...
    $("#jqGrid_lista_B").jqGrid({
        ...
        colModel: [
                    ...
                    { name: 'DepartamentoNombre', index: 'DepartamentoNombre', hidden: true  },
                    { name: 'ProvinciaNombre', index: 'ProvinciaNombre', hidden: true },
                    { name: 'DistritoNombre', index: 'DistritoNombre', hidden: true  }
		        ],
        height: '100%',
...
function fn_ListagrillaDocumentos() {
    ...
    fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/ListaDocumentosContrato",
                        arrParametros,
                        function(jsondata) {
...
function fn_ListaDatosContratoProveedor() {
    ...
    fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/ListarContratoProveedores",
                       arrParametros,
                       function(jsondata) {
...
function fn_Contrato_GuardarWM() {
    ...
    var paramArray = [
       ...
       fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarContratoActualizar",
                   paramArray,
                   function(result) {
                       if (result == "0") {
...
function fn_contrato_GuardarYEnviarWM() {
   ...
   fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/GuardarYEnviar",
                       paramArray,
...
function fn_Volver_A_Listado() {
    fn_util_redirect('frmSituacionCreditoListado.aspx');
}
...
function fn_ListaDatosNotariales(tipoDatoNotarial) {
    ...
    try {
        ...
        fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/ListadoContratoNotarialPaginado",
                            arrParametros,
                            function(jsondata) {
                                if (tipoDatoNotarial == TipoDatoNotarial.DatoNotarial) {
...
function fn_ListaCondicionesAdicionales() {
    ...
    fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/ListaCondicionesAdicionales",
                       arrParametros,
                       function(jsondata) {
...
function fn_ListaRepresentantesCliente() {
    ...
    fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/ListaRepresentantes",
                       arrParametros,
                       function(jsondata) {
...
function fn_BienInmueble_eliminarWM() {
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/BienesEliminar",
                   paramArray,
...
function fn_GuardarBienInmuebleNuevo() {
    ...
    if (EsValidoBienInmueble()) {
        ...
        fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarBienInmuebleNuevo",
                       arrParametros,
                       function() {
                           $("#hddFlagModificado").val("1");
                           $("#hddGeneraContrato_Adjunto").val("0");
...
function  fn_GuardarBienInmuebleEditar(){
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarBienInmuebleEditar",
                   arrParametros,
                   function() {
                       $("#hddFlagModificado").val("1");
                       $("#hddGeneraContrato_Adjunto").val("0");
...
function fn_GuardarMaquinaEditar() {
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarMaquinaEditar",
                   arrParametros,
                   function() {
...
function fn_GuardarDatosOtrosNuevo() {
    ...
    if (EsValidoDatosOtros()) {
        ...
        fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarDatosOtrosNuevo",
            arrParametros,
            function() {
                $("#hddFlagModificado").val("1");
                $("#hddGeneraContrato_Adjunto").val("0");
...
function fn_GuardarDatosOtrosEditar() {
   ...
   fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarDatosOtrosEditar",
                   arrParametros,
                   function() {
...
function fn_DatosNotariales_eliminarWM() {
    ...
    fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/DatosNotarialesEliminar",
                       paramArray,
...
function fn_Adenda_eliminarWM() {
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/DatosNotarialesEliminar",
                   paramArray,
...
function fn_GuardarAdendaEditar() {
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarAdendaEditar",
                   arrParametros,
                   function() {
                       $("#jqGrid_lista_I").trigger("reloadGrid");
                       fn_CancelarAdenda();
...
function fn_GuardarAdendaNuevo() {
    ...
    if (EsValidoAdenda()) {
        ...
        fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarAdendaNuevo",
                   arrParametros,
                   function() {
                       $("#jqGrid_lista_I").trigger("reloadGrid");
                       fn_CancelarAdenda();
...
//************************************************************
 ...
 function fn_Representantes_eliminarWM() {
     ...
     fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/RepresentanteEliminar",
                   paramArray,
...
function fn_generarAnexosWM() {
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GuardarContratoYGenerarAnexos",
                   paramArray,
...
function fn_aprobarContratoWM() {
	...
	fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/Aprobar",
		           paramArray,
		           ResultadoAprobar,
                   function(result) {
                       var err = eval("(" + result.responseText + ')');
    ...
    if ($(  "#hddFlagModificado").val() == "0") {
        parent.fn_mdl_confirma("¿Está seguro de efectuar el envío a notaría?"
		                        , function () {
                                    ...
                                    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/EnviaNotaria",
                                                    paramArray,
...
function fn_AnularContratoWM() {
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/Anular",
                   paramArray,
                   ResultadoAnular,
                   function(result) {
                       var err = eval("(" + result.responseText + ')');
...
function fn_ExisteArrendamientoFinanciero() {
    ...
    fn_util_AjaxSyncWM("frmSituacionCreditoRegistro.aspx/ExisteArrendamientoFinanciero",
                       paramArray,
                       function(result) {
                           if (result == "0") {
                               bResult = true;
        ...
        if ($("#hddFlagModificado").val() == "0") {
            ...
            parent.fn_mdl_confirma("¿Está seguro de cambiar el estado ha formalizado?"
                                    , function() {
                                                    ...
                                                    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/Formalizado",
                                                                       paramArray,
...
function fn_ActualizaBloqueo(pstrBloqueoCodigo) {
    ...
    fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/ActualizaBloqueo",
             arrParametros,
             function(result) {
                 parent.fn_unBlockUI();
...
function fn_retornarFlujo(){
	...
	parent.fn_mdl_confirma(
                    ...
                    function() {
						...
						fn_util_AjaxWM("frmSituacionCreditoRegistro.aspx/GestionFlujo",
							   paramArray,
							   function(resultado) {
									parent.fn_unBlockUI();
