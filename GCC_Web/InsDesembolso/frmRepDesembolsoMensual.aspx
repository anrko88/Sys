<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmRepDesembolsoMensual.aspx.vb" Inherits="InsDesembolso_frmRepDesembolsoMensual" %>
...
<head runat="server">
    ...
    <script type='text/javascript' src="frmRepDesembolsoMensual.aspx.js"> </script>
</head>
<body>
                ...
                <tr>
                    ...
                    <td class="titulos">
                        ...
                        <div class="css_lbl_titulo">
                            Reporte Desembolsos Mensuales</div>
                    </td>
                    <td class="espacio">
                        &nbsp;
                    </td>
                        ...
                        <td class="cuerpo">
                            ...
                            <div id="dv_datos" class="dv_tabla_contenedora">
                                <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" style="width:500px">
                                    <tr>
                                        <td class="label">
                                            Fecha&nbsp;Desembolsos&nbsp;Mensuales&nbsp;&nbsp;Desde
                                        </td>
                                        <td class="input">
