<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmDocumentosListado.aspx.vb" Inherits="InsDesembolso_frmDocumentosListado" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmDocumentosListado.aspx.js"></script>
...
<body>
        ...
        <div id="dv_cuerpoModal">
    	    ...
    	    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo">Documentos</div>
			    </td>
			    <td class="espacio">&nbsp;</td>
			    <td class="botones">
	...
	<input type="hidden" name="hddCodInsDesembolso" id="hddCodInsDesembolso" value="" runat="server" />
