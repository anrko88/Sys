<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmLiquidacionesListado.aspx.vb" Inherits="Pagos_frmLiquidacionesListado" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmLiquidacionesListado.aspx.js"> </script>
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">
                        Liquidaciones ::  <label id="lblOperacion" runat="server"> Listado </label></div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                <td class="botones">
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_buscarPagoCuotas(true);">
                            <img alt="" src="../Util/images/ico_acc_buscar.gif" /><br />
                            Buscar </a>
                    </div>
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_limpiarForm();">
                            <img src="../Util/images/ico_acc_limpiar.gif" /><br />
                            Limpiar </a>
                    </div>
                    ...
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_abreEditar()">
                            <img alt="" src="../Util/images/ico_acc_editar.gif" /><br />
                            Editar </a>
                    </div>      
                    <div id="Div1" class="dv_img_boton">
                        <a href="javascript:fn_agregar();">
                            <img alt="" src="../Util/images/ico_acc_agregar.gif" /><br />
                            Agregar </a>
                    </div>   
                </td>
            </tr>
            ...
            <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="cuerpo">
                        ...
                        <input type="hidden" name="hddCodigoLiquidacion" id="hddCodigoLiquidacion" value="" runat="server" />
                        ...
                        <div class="dv_tabla_contenedora">
                            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3">
                                ...
                                <tr>
                                    ...
                                    <td class="input">
                                        <input id="txtCodigoLiquidacion" type="text" class="css_input" />
                                    </td>
                                    <td class="label">
                                        Fecha Valor Inicio</td>
                                    <td class="input">
                                        <input id="txtFechaValorInicio" type="text" class="css_input" size="11" />
                                    </td>
                                    <td class="label">
                                        Fecha Valor Fin</td>
                                    <td class="input">
                                        <input id="txtFechaValorFin" type="text" class="css_input" size="11" /></td>
                                </tr>
                                <tr>
                                    <td class="label">
                                        Tipo Liquidación
                                    ...
                                    <td class="input">
                                        <select id="cmbTipoLiquidacion" name="cmbTipoLiquidacion" runat="server">
                                        </select>
                                    </td>
                                    <td class="label">
                                        Estado
                                ...
                                <tr>
                                    ...
                                    <td class="input">
                                        <select id="cmbFlagAdenda" name="cmbFlagAdenda" runat="server">
