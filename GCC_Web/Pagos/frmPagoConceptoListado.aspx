<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPagoConceptoListado.aspx.vb" Inherits="Pagos_frmPagoConceptoListado" %>
...
<head id="Head1" runat="server">
    ...
    <!-- Local -->
    <script type='text/javascript' src="frmPagoConceptoListado.aspx.js"> </script>
            ...
            <tr>
                ...
                <td class="titulos">
                    ...
                    <div class="css_lbl_titulo">
                        Pago de Otros Conceptos :: Listado</div>
                </td>
                <td class="espacio">
                    &nbsp;
                </td>
                <td class="botones">
                   ...
                   <div id="dv_img_boton" class="dv_img_boton">
                    ...
                    <div id="Div2" class="dv_img_boton">
                        <a href="javascript:fn_abreCartas();">
            ...
            <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="cuerpo">
                        ...
                        <input type="button" name="btnBuscar" id="btnBuscar" onclick="javascript:fn_buscar(true);" style="display: none;" />
