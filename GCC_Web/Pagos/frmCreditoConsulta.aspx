<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCreditoConsulta.aspx.vb" Inherits="Pagos_frmCreditoConsulta" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src="frmCreditoConsulta.aspx.js"></script>
        ...
        <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="botones">
                    ...
                    <div id="dv_img_boton" class="dv_img_boton">
                        <a href="javascript:fn_buscarCredito(true);">
