...
Partial Class Pagos_frmPagoCuotasRegistro
    Inherits GCCBase

    Dim objLog As New GCCLog("frmPagoCuotasRegistro.aspx.vb")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                GCCUtilitario.CargarComboValorGenerico(Me.cmbTiendaPago, GCCConstante.C_TABLAGENERICA_COD_TIENDA)
                GCCUtilitario.CargarComboValorGenerico(Me.cmbEstadoRecuperacion, GCCConstante.C_TABLAGENERICA_ESTADO_RECUPERACION)

                GCCUtilitario.CargarComboMotivoBasilea(Me.cmbMovimientoBasilea)
                ...
                If strCodSolicitudCredito Is Nothing Then
                    ...
                    Else
                        ...
                        Me.hddTipoTransaccion.Value = GCCConstante.C_TX_EXTORNO
                    End If
                ...
                Else
                    ...
                    ObtieneDatosPagoCuotas(strCodSolicitudCredito, strNumSecRecuperacion)
                End If
...
#Region "Métodos"
    ...
    Public Shared Function ConsultaContrato(ByVal strCodSolicitudCredito As String) As ESolicitudcredito
        ...
        Try
            ...
            If dtContrato.Rows.Count > 0 Then
                ...
                oESolicitudcredito.Estadosolicitudcredito = dtContrato.Rows(0).Item("EstadoContrato").ToString

                oESolicitudcredito.NombreBanca = dtContrato.Rows(0).Item("NombreBanca").ToString
                oESolicitudcredito.ClasificacionBien = dtContrato.Rows(0).Item("ClasificacionBien").ToString
                oESolicitudcredito.DesZonal = dtContrato.Rows(0).Item("Zonal").ToString
                oESolicitudcredito.NombreSectorista = dtContrato.Rows(0).Item("NombreSectorista").ToString
                oESolicitudcredito.PorcenTasaActiva = Val(dtContrato.Rows(0).Item("PorcenTasaActiva").ToString)
                oESolicitudcredito.EstadoOperacionActiva = dtContrato.Rows(0).Item("EstadoOperacionActiva").ToString
                oESolicitudcredito.NombreEstadoOperacionActiva = dtContrato.Rows(0).Item("NombreEstadoOperacionActiva").ToString
        ...
        Catch ex As Exception
            Dim oESolicitudcredito As New ESolicitudcredito
            oESolicitudcredito.CodError = 1
            oESolicitudcredito.MsgError = "No se pudo cargar los datos del contrato: " + ex.Message
            Return oESolicitudcredito
        End Try
    ...
    <WebMethod()> _
    Public Shared Function ObtenerCuentasContrato(ByVal strCodSolicitudCredito As String) As String()
        ...
        Try
            ...
            'Ejecuta Consulta
            Dim dtContrato As DataTable = GCCUtilitario.DeserializeObject(Of DataTable)(objLContratoNTx.ObtenerCuentasContrato(strCodSolicitudCredito))

            Dim ListaCuentas As New List(Of String)
            ListaCuentas.Add(dtContrato.Rows.Count)

            Dim i As Integer
            For i = 0 To dtContrato.Rows.Count - 1
                ListaCuentas.Add(dtContrato.Rows(i).Item("TipoCuenta").ToString & "|" & dtContrato.Rows(i).Item("MonedaCuenta").ToString & "|" & dtContrato.Rows(i).Item("NumeroCuenta").ToString)
            Next
    ...
    'IBK RPR 26/12/2012
    Private Sub ObtieneDatosPagoCuotas(ByVal strCodSolicitudCredito As String, ByVal strNumSecRecuperacion As String)
        ...
        Try
            ...
            With objECreditoRecuperacion
                .CodOperacionActiva = GCCUtilitario.NullableString(strCodSolicitudCredito)
                .TipoRubroFinanciamiento = "000"
                .CodIfi = "9999"
                .TipoRecuperacion = "R"
                .NumSecRecuperacion = GCCUtilitario.StringToInteger(strNumSecRecuperacion)
            End With
            Dim strECreditoRecuperacion As String = GCCUtilitario.SerializeObject(objECreditoRecuperacion)

            'Ejecuta Consulta
            Dim dtPagoCuotas As DataTable = GCCUtilitario.DeserializeObject(Of DataTable)(objLPagosNTx.ObtenerPagoCuotas(strECreditoRecuperacion))

            If dtPagoCuotas.Rows.Count > 0 Then
                txtFechaValor.Value = GCCUtilitario.CheckDateString(dtPagoCuotas.Rows(0).Item("FechaValorRecuperacion"), "C")
                txtNumSecRecuperacion.Value = dtPagoCuotas.Rows(0).Item("NumSecRecuperacion").ToString.Trim
                txtCodAutorizacionRecuperacion.Value = dtPagoCuotas.Rows(0).Item("CodAutorizacionRecuperacion").ToString.Trim

                GCCUtilitario.SeleccionaCombo(cmbCodMoneda, dtPagoCuotas.Rows(0).Item("CodMoneda").ToString.Trim)
                GCCUtilitario.SeleccionaCombo(cmbMovimientoBasilea, dtPagoCuotas.Rows(0).Item("CodigoMovimientoBasilea").ToString.Trim)

                'Via de Cobranza
                hddTipoViaCobranza.Value = dtPagoCuotas.Rows(0).Item("TipoViaCobranza").ToString.Trim
                ...
                hddEstadoRecuperacion.Value = dtPagoCuotas.Rows(0).Item("EstadoRecuperacion").ToString.Trim
                ...
                Else
                    txtMotivo.Value = dtPagoCuotas.Rows(0).Item("DescripcionCargo").ToString.Trim
                End If

                'Cargo en Cuenta
                GCCUtilitario.SeleccionaCombo(cmbCodMonedaCargo, dtPagoCuotas.Rows(0).Item("CodMonedaCargo").ToString.Trim)
                GCCUtilitario.SeleccionaCombo(cmbTipoCuenta, dtPagoCuotas.Rows(0).Item("TipoCuenta").ToString.Trim)

                Dim strNroCuenta As String = dtPagoCuotas.Rows(0).Item("NroCuenta").ToString.Trim
                ...
                'Flag Cuenta Propia
                hddFlagCuentaPropia.Value = dtPagoCuotas.Rows(0).Item("FlagCuentaPropia").ToString
                If hddFlagCuentaPropia.Value = "" Then
                    hddFlagCuentaPropia.Value = "S"
                ElseIf hddFlagCuentaPropia.Value = "N" Then
                    txtCUClienteCargo.Value = dtPagoCuotas.Rows(0).Item("CodUnicoClienteCargo").ToString.Trim
                End If

            End If

            cmbNroCuotas.Items.Add(New ListItem(dtPagoCuotas.Rows.Count.ToString + " Cuotas", dtPagoCuotas.Rows.Count))
            cmbNroCuotas.Value = dtPagoCuotas.Rows.Count
    ...
    ''' </remarks>
    <WebMethod()> _
    Public Shared Function ObtenerDetalleCuotas(ByVal pstrCodSolicitudCredito As String, _
        ...
        Try
            ...
            'Ejecuta Consulta
            Dim dtDetalleCuotas As DataTable = GCCUtilitario.DeserializeObject(Of DataTable)(objPagosNTx.ObtenerDetalleCuotas(strECreditoRecuperacion))
...
#Region "Ejecucion Pago Cuotas"
    ...
    ''' </summary>
    <WebMethod()> _
    Public Shared Function AnularPagoCuotas(ByVal pstrCodOperacionActiva As String, _
                                                ...
                                                ByVal pstrMotivoAnulacionExtorno As String) As ECreditoRecuperacion
        ...
        Try
            ...
            With objECreditoRecuperacion
                ...
                .CodAutorizacionRecuperacion = Val(pstrCodAutorizacionRecuperacion)
                .CodUsuario = GCCSession.CodigoUsuario()
            ...
            'Validar fecha del pago (para pagos de cuotas)
            pstrFechaRecuperacion = CDate(pstrFechaRecuperacion).ToString("yyyyMMdd")
            If pstrFechaRecuperacion < strFechaHoy And pstrTipoRecuperacion = "R" Then
            ...
            objECreditoRecuperacion.EstadoRecuperacion = "A"
            strECreditoRecuperacion = GCCUtilitario.SerializeObject(objECreditoRecuperacion)
    ...
    Public Shared Function ExtornarPagoCuotas(ByVal pstrCodOperacionActiva As String, _
        ...
        Try
            ...
            'Cambiar estado a Extornado y ejecutar reversa
    ...
    ''' </summary>
    <WebMethod()> _
    Public Shared Function SeleccionarAplicacionComision(ByVal pstrCodOperacionActiva As String, _
                                                         ByVal pstrCodigoLiquidacion As String, _
                                                         ByVal pstrTipoRecuperacion As String, _
                                                         ByVal pstrNumCuotaCalendario As String, _
                                                         ByVal pstrNumSecRecupComi As String, _
                                                         ByVal pstrAplicacion As String) As Boolean
        'Variables
        Dim objPagosTx As New LPagosTx
        Dim objPagosNTx As New LPagosNTx
        ...
        Try
            ...
            With objECreditoRecuperacionComision
                ...
                .NumSecRecupComi = Val(pstrNumSecRecupComi)
                .Aplicacion = pstrAplicacion
                .CodUsuario = GCCSession.CodigoUsuario
            End With
            Dim strECreditoRecuperacionComision As String = GCCUtilitario.SerializeObject(objECreditoRecuperacionComision)
            objPagosNTx.SeleccionarAplicacionComision(strECreditoRecuperacionComision)
    ...
    Public Shared Function EjecutaPagoCuotas(ByVal pstrCodOperacionActiva As String, _
        ...
        '                numSaldo = Pagos_frmPagoCuotasRegistro.saldoCuenta(pstrCU, strTipoCta, pstrCodMoneda, pstrCodTienda, pstrNroCta, strRta)
        '            End If
        ...
        '        numEstado = 2
        '        Pagos_frmPagoCuotasRegistro.ActualizaInsDesembolsoEstado(pstrNroContrato, pstrNroInstruccion, "009", strFlagLPC)
        '        numEstado = Pagos_frmPagoCuotasRegistro.CargaEnCuentas(pstrNroContrato, pstrNroInstruccion, strError)
        '        Select Case numEstado
        '            Case -1
        '                Return ("2|" & strError)
        '            Case -2
        '                str10 = ("1|" & strError)
        '                Pagos_frmPagoCuotasRegistro.ActualizaInsDesembolsoEstado(pstrNroContrato, pstrNroInstruccion, "007", strFlagLPC)
        '                Return str10
        '            Case 3
        '                Dim numRetPC As Integer
        '                strFlagLPC = "1"
        '                If (pstrEnvioLPC <> "1") Then
        '                    numRetPC = Pagos_frmPagoCuotasRegistro.EjecutarDesembolsoLPC(pFlag, pstrNroInstruccion, GCCSession.CodigoUsuario)
        '                Else
        '                    numRetPC = 0
        '                End If
        '                If (numRetPC <> 0) Then
        ...
        '                End If
        '                strFlagLPC = "1"
        '                Pagos_frmPagoCuotasRegistro.ActualizaInsDesembolsoEstado(pstrNroContrato, pstrNroInstruccion, "006", strFlagLPC)
        '                'Finalizo WIO
            ...
            If ((Not table Is Nothing) AndAlso (table.Rows.Count > 0)) Then
                ...
                Try
                    ...
                    Do While enumerator.MoveNext
                        ...
                        If ((current.Item("CodMedioAbono").ToString = "002") Or (current.Item("CodMedioAbono").ToString = "006")) And blnMonedasCoiciden Then
                            ...
                            If ((current.Item("CodEstadoEjecucionPago").ToString.Trim <> "02") And (current.Item("CodEstadoEjecucionPago").ToString.Trim <> "04")) Then
                                ...
                                If (strCodTipoOperacion = "002") Then
                                    ...
                                    If (codMonedaAgrupacion <> strCodMonedaPago) Then
                                        numMontoIGV = Pagos_frmPagoCuotasRegistro.tipoCambio(codMonedaAgrupacion, strCodMonedaPago, nbrTCAgrp, nbrTCPrefVta, nbrTCPrefCmp, numIGVCargo, flagAbono)
                                        numMontoAbono = Decimal.Add(Pagos_frmPagoCuotasRegistro.tipoCambio(codMonedaAgrupacion, strCodMonedaPago, nbrTCAgrp, nbrTCPrefVta, nbrTCPrefCmp, nbrMontoPago, flagAbono), numIGVCargo)
                                    Else
                                ...
                                Else ' (strCodTipoOperacion = "002") Then
                                    ...
                                    If (strCodAgrupacion = "02") Then
                                        ...
                                        If (codMonedaAgrupacion <> strCodMonedaPago) Then
                                            numMontoAbono = Pagos_frmPagoCuotasRegistro.tipoCambio(codMonedaAgrupacion, strCodMonedaPago, nbrTCAgrp, nbrTCPrefVta, nbrTCPrefCmp, numMontoAbonoSAdel, flagAbono)
                                        Else
                                    ...
                                    If ((strCodAgrupacion = "05") Or (strCodAgrupacion = "07") Or (strCodAgrupacion = "13")) Then
                                        If (codMonedaAgrupacion <> strCodMonedaPago) Then
                                            numMontoAbono = Pagos_frmPagoCuotasRegistro.tipoCambio(codMonedaAgrupacion, strCodMonedaPago, nbrTCAgrp, nbrTCPrefVta, nbrTCPrefCmp, nbrMontoPago, flagAbono)
                                        Else
                                            numMontoAbono = nbrMontoPago
                                        End If
                                    End If
                                ...
                                If flagTengoCU Then
                                    ...
                                    pstrTipoCambio = ""
                                    pstrImportePagar = ""
                                    Dim strTrama As String = Pagos_frmPagoCuotasRegistro.pArmaTramaDesembolso(pstrNumeroInterno, pintTipoCuenta, pintTipoMoneda, pstrNroOficina, pstrCodigoUnico, pstrNroCuenta, numMontoAbono, pstrExisteTCambio, pstrMonedaDocumento, pstrTipoCambio, pstrImportePagar, current.Item("CodAgrupacion").ToString, pstrCodTran, pstrTrama)
                                    If (strUsoWS = "SI") Then
                                    ...
                                    Pagos_frmPagoCuotasRegistro.LogEnvioDesembolso(pstrNroContrato, pstrNroInstruccion, current.Item("CodAgrupacion").ToString, pintTipoMoneda, current.Item("CodProveedor").ToString, pstrTrama, strCodRetorno, strResultado)
                                    ...
                                    If (strArray(0).ToString <> "0") Then
                                        ...
                                        flagError = True
                                        Pagos_frmPagoCuotasRegistro.actualizarEstadoEjecucionPago(pstrNroContrato, pstrNroInstruccion, current.Item("CodAgrupacion").ToString, current.Item("CodMonedaAgrupacion").ToString, current.Item("CodProveedor").ToString, "03", strCodMonedaPago, numMontoAbonoLog, numMontoIGV)
                                    Else
                                        Pagos_frmPagoCuotasRegistro.actualizarEstadoEjecucionPago(pstrNroContrato, pstrNroInstruccion, current.Item("CodAgrupacion").ToString, current.Item("CodMonedaAgrupacion").ToString, current.Item("CodProveedor").ToString, "02", strCodMonedaPago, numMontoAbonoLog, numMontoIGV)
                                    End If
                                Else 'If flagTengoCU Then
                                    ...
                                    flagError = True
                                    Pagos_frmPagoCuotasRegistro.actualizarEstadoEjecucionPago(pstrNroContrato, pstrNroInstruccion, current.Item("CodAgrupacion").ToString, current.Item("CodMonedaAgrupacion").ToString, current.Item("CodProveedor").ToString, "03", strCodMonedaPago, nbrMontoPago, numIGVCargo)
                        ...
                        Else 'If (current.Item("CodMedioAbono").ToString = "002") Then
                            If ((current.Item("CodEstadoEjecucionPago").ToString.Trim <> "04") And (current.Item("CodEstadoEjecucionPago").ToString.Trim <> "02")) Then
                                ...
                                Else ' (strCodTipoOperacion = "002") Then
                                    ...
                                    numMontoAbonoLog = numMontoAbono
                                End If ' (strCodTipoOperacion = "002") Then
                                Pagos_frmPagoCuotasRegistro.actualizarEstadoEjecucionPago(pstrNroContrato, pstrNroInstruccion, current.Item("CodAgrupacion").ToString, current.Item("CodMonedaAgrupacion").ToString, current.Item("CodProveedor").ToString, "04", strCodMonedaPago, numMontoAbonoLog, numMontoIGV)
            ...
            If tx.callProgramaHost((strCU & strTipoCta), argsUsuarioTld, argsAgenciaTld, "LPCO015", "SaldoCuenta", strMensaje, strDatos) Then
                ...
                Do While (i <= num8)
                    ...
                    If (strMoneda = strCodMoneda) Then
                        ...
                        ListaCuentas.Add(strTienda & "-" & Trim(NroCta))
