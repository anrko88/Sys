...
Partial Class Formalizacion_frmContratoRegistro
    Inherits GCCBase
    ReadOnly _objLog As New GCCLog("frmContratoRegistro.aspx.vb")
...
#Region "Contrato"
    ...
    Public Shared Function GuardarContratoActualizar(ByVal pCodigoContrato As String, _
                                                     ...
                                                     ByVal pModificado As Boolean, _
                                                     ByVal pOpcionCompra As String, _
                                                     ByVal pComisionActivacion As String, _
                                                     ByVal pComisionEstructuracion As String) As String
        Try
            ...
            'Inicio IBK - AAE
            objEGccContratootroconcepto.ComisionActivacion = GCCUtilitario.StringToDecimal(pComisionActivacion)
            objEGccContratootroconcepto.ComisionEstructuracion = GCCUtilitario.StringToDecimal(pComisionEstructuracion)
            objEGccContratootroconcepto.ImporteOpcionCompra = GCCUtilitario.StringToDecimal(pOpcionCompra)
            'Fin IBK - AAE
            ...
            Dim blnResult As Boolean = objContratoTx.fblnModificarContrato2(pESolicitudCredito, _
                                                                           pEGccContratootroconcepto)
            'Fin IBK
    ...
    Public Shared Function GuardarYEnviar(ByVal pCodigoContrato As String, _
        ...
        Try
            ...
            If pCodigoEstadoContrato = GCCConstante.C_CODIGO_ESTADO_CONTRATO_ELABORADO Then
                ...
                objESolicitudCredito.CodigoUsuario = GCCSession.CodigoUsuario.ToString()
                objESolicitudCredito.NombreUsuario = GCCSession.NombreUsuario.ToString()
                objESolicitudCredito.PerfilUsuario = GCCSession.DescripcionPerfil.ToString()
                ...
                'Inicio IBK - AAE
                objEGcc_contratootroconcepto.ComisionActivacion = GCCUtilitario.StringToDecimal(pComisionActivacion)
                objEGcc_contratootroconcepto.ComisionEstructuracion = GCCUtilitario.StringToDecimal(pComisionEstructuracion)
                objEGcc_contratootroconcepto.ImporteOpcionCompra = GCCUtilitario.StringToDecimal(pOpcionCompra)
                'Fin IBK - AAE
                objESolicitudCredito.ClienteRazonSocial = GCCUtilitario.NullableString(pClienteRazonSocial)
                objESolicitudCredito.ClienteDomicilioLegal = GCCUtilitario.NullableString(pClienteDomicilioLegal)
                ...
                Dim blnResult As Boolean = objContratoTx.ContratoGuardarYEnviar2(pESolicitudCredito, _
                                                                                pEGcc_contratootroconcepto)
                'Fin IBK
    ...
    Private Sub LeerDatosCliente(ByVal codSolicitudCredito As String)
        ...
        For Each oRow As DataRow In dtCliente.Rows
            ...
            'If Not oRow.Item("TipoPersona") Is DBNull.Value Then
            '    txtTipoPersona.Value = oRow.Item("TipoPersona").ToString().Trim
            'End If
    ...
    Private Sub LeerContrato(ByVal codSolicitudCredito As String)
        ...
        For Each oRow As DataRow In dtContrato.Rows
            ...
            If Not oRow.Item("NombreMoneda") Is DBNull.Value Then
                txtMoneda.Value = oRow.Item("NombreMonedaAPP").ToString().Trim()
            End If
            ...
            If Not oRow.Item("Uso") Is DBNull.Value Then
                ...
                txtUsoInmueble.Value = oRow.Item("Uso").ToString().Trim()
                txtUsoBienMaquina.Value = oRow.Item("Uso").ToString().Trim()
                txtUsoDatosOtros.Value = oRow.Item("Uso").ToString().Trim()
            End If
            If Not oRow.Item("Ubicacion") Is DBNull.Value Then
                hddUbicacion.Value = oRow.Item("Ubicacion").ToString().Trim()
                txtUbicacionInmueble.Value = oRow.Item("Ubicacion").ToString().Trim()
                txtUbicacionBienMaquina.Value = oRow.Item("Ubicacion").ToString().Trim()
                txtUbicacionDatosOtros.Value = oRow.Item("Ubicacion").ToString().Trim()
            End If
        ...
        ' Bienes
        If (Array.IndexOf(GCCConstante.DestinoCredito_Inmueble, hddTipoRubroFinanciamiento.Value) <> -1) Then
            GCCUtilitario.CargarDepartamento(cmbDepartamentoInmueble)
            GCCUtilitario.CargarComboValorGenerico(Me.cmbEstadoBienInmueble, GCCConstante.C_TABLAGENERICA_ESTADO_BIEN)
        ElseIf (Array.IndexOf(GCCConstante.DestinoCredito_Maquinaria, hddTipoRubroFinanciamiento.Value) <> -1) Or (Array.IndexOf(GCCConstante.DestinoCredito_Vehiculo, hddTipoRubroFinanciamiento.Value) <> -1) Then
            GCCUtilitario.CargarDepartamento(cmbDepartamentoMaquinaria)
            GCCUtilitario.CargarComboValorGenerico(Me.cmbEstadobienMaquina, GCCConstante.C_TABLAGENERICA_ESTADO_BIEN)

        ElseIf (Array.IndexOf(GCCConstante.DestinoCredito_Otros, hddTipoRubroFinanciamiento.Value) <> -1) Then
            GCCUtilitario.CargarDepartamento(cmbDepartamentoDatosOtros)
            GCCUtilitario.CargarComboValorGenerico(Me.cmbEstadoDatosOtros, GCCConstante.C_TABLAGENERICA_ESTADO_BIEN)
        End If
