...
Partial Class Formalizacion_frmCheckListLegalRegistro
    Inherits GCCBase

    Dim objLog As New GCCLog("frmCheckListLegalRegistro.aspx.vb")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                hddconsOrigenCondicion.Value = GCCConstante.C_ORIGENDOC_CHECKLIST_LEGAL
...
#Region "Web Métodos"
    ...
    ''' <summary>
    ''' ListaRepresentantesContratoTotal
    ''' </summary>
    ''' <param name="pPageSize"></param>
    ''' <param name="pCurrentPage"></param>
    ''' <param name="pSortColumn"></param>
   ...
   Public Shared Function EliminaRepresentanteContrato(ByVal pNumeroContrato As String, _
    ...
    ''' <param name="pNumeroContrato"></param>
    ''' <param name="pAprobar"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Shared Function EstadoAprobarLegal(ByVal pCodigoContratoDocumento As Integer, _
                                              ByVal pNumeroContrato As String, _
                                              ByVal pAprobar As Integer) As String

        Try
            Dim objContratoDocumentoTx As New LContratoTx   'LCheckListTx
            Dim oEGccContratoDocumento As New EGcc_contratodocumento
            Dim strEGccontratoDocumento As String
            With oEGccContratoDocumento
                .Aprobarlegal = GCCUtilitario.CheckInt(pAprobar)
                .Numerocontrato = GCCUtilitario.NullableString(pNumeroContrato)
                .Codigocontratodocumento = pCodigoContratoDocumento

            End With


            strEGccontratoDocumento = GCCUtilitario.SerializeObject(oEGccContratoDocumento)
            Dim intResult As Boolean = objContratoDocumentoTx.EstadoAprobarLegal(strEGccontratoDocumento)
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
   Public Shared Function EliminaContratoDocumento(ByVal pstrcodInstruccionDesembolso As String, _
                                                            ByVal pstrcodsolicitudcredito As String, _
                                                            ByVal pstrtcdia As Decimal, _
                                                            ByVal pstrnroticket As String) As String

        Try
            Dim objRecalculaTx As New LInstruccionDesembolsoTx

            Dim oEGcRecalcula As New EGCC_InsDesembolso
            Dim strEGcRecalcula As String
            With oEGcRecalcula
            ...
            strEGcRecalcula = GCCUtilitario.SerializeObject(oEGcRecalcula)
            Dim intResult As String = objRecalculaTx.recalcula(strEGcRecalcula)
 ...
 Public Shared Function ActualizarSolicitudCredito(ByVal strCodigo As String, _
        ...
        Try
            ...
            'Dim intResult As Boolean = objActualizaSolicitudCreditoTx.CheckLisComercialUpd(strESolicitudCreditoBien, strListEGcc_contratoCuenta)
    ...
    ''' <summary>
    ''' ActualizarGestionComercialDevolver
    ''' </summary>
    ''' <param name="strCodSolicitudCredito"></param>
    ''' <param name="intFlagEnvioLegal"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Shared Function ActualizarGestionComercialDevolver(ByVal strCodSolicitudCredito As String, _
    ...
    ''' <summary>
    ''' ActualizarGestionComercialAprobar
    ''' </summary>
    ''' <param name="strCodSolicitudCredito"></param>
    ''' <param name="intFlagEnvioLegal"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    <WebMethod()> _
   Public Shared Function ActualizarGestionComercialAprobar(ByVal strCodSolicitudCredito As String, _
                                                           ByVal intFlagEnvioLegal As Integer) As String
        Try
            Dim objSolicitudcreditoTx As New LContratoTx
            Dim oEGcSolicitudcredito As New ESolicitudcredito
            ...
            With oEGcSolicitudcredito
                .Codsolicitudcredito = GCCUtilitario.NullableString(strCodSolicitudCredito)
                .FlagEnvioLegal = intFlagEnvioLegal
                .Codigoestadocontrato = GCCConstante.C_CODIGO_ESTADO_CONTRATO_ELABORADO
    ...
    ''' <param name="argFCDTIPOCUENTA2"></param>
    ''' <param name="argFCDCODMONEDA2"></param>
    ''' <param name="argFCDCODTIENDA2"></param>
    ''' <param name="argFCDCODCATEGORIA2"></param>
    ''' <param name="argFCDNUMCUENTA2"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
    <WebMethod()> _
    ...
    ''' <remarks></remarks>
    <WebMethod()> _
    Public Shared Function ActualizaFlagAprobacionLegal(ByVal pFlagAprobacionLegal As Integer, _
                                                        ByVal pNumeroContrato As String, _
                                                        ByVal pCodigoContratoDocumento As Integer) As String

        Try
            Dim objFlagAprobacionLegalTx As New LCheckListTx
            'Dim oEGccRepresentanteContrato As New EGcc_contratorepresentante
            'Dim strEGccontratoDocument As String
            'With oEGccRepresentanteContrato
            ' .Codigorepresentante = pCodigoRepresentante
            ' .Numerocontrato = GCCUtilitario.NullableString(pNumeroContrato)
            ' .Codigotiporepresentante = GCCUtilitario.NullableString(pCodigoTipoRepresentante)
            ...
            'strEGccontratoRepresentante = GCCUtilitario.SerializeObject(oEGccRepresentanteContrato)
            Dim intResult As Boolean = objFlagAprobacionLegalTx.ActualizaFlagAprobacionLegal(pFlagAprobacionLegal, pNumeroContrato, pCodigoContratoDocumento)
            ...
            If odtbDatos IsNot Nothing Then
                If odtbDatos.Rows.Count > 0 Then
                    For Each dr As DataRow In odtbDatos.Rows
                        ...
                        hddCodigoEstadoContrato.Value = dr("codigoestadocontrato").ToString.Trim
    ...
    Protected Sub GestionBloqueo(ByVal strCodigoContrato As String)
        ...
        Try
            ...
            With objEBloqueo
                ...
                .Modulo = GCCConstante.C_BLOQUEO_MODULO_CHECKLEGAL
