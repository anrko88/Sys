<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmContratoListado.aspx.vb" Inherits="Formalizacion_frmContratoListado" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmContratoListado.aspx.js"></script>
	    ...
	    <table id="tb_cuerpoCabecera" style="border: 0;" cellpadding="0" cellspacing="0">
		    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo">Contrato :: Listado</div>
			    </td>
			    <td class="espacio">
			        &nbsp;    								
			    </td>
			    <td class="botones">
    				<div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_buscarContratos(true);">
						    <img alt="Buscar" src="../Util/images/ico_acc_buscar.gif" style="border: 0;"  title="Buscar" /><br />
						    Buscar
					    </a>
				    </div>	
				    ...
				    <div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_limpiarContrato();">
						    <img alt="Limpiar" src="../Util/images/ico_acc_limpiar.gif" style="border: 0;" title="Limpiar" /><br />
						    Limpiar
					    </a>
				    </div>	
				    ...
				    <div id="dv_img_boton" class="dv_img_boton">
					    <a href="javascript:fn_abreDetalle();">
						    <img alt="Editar" src="../Util/images/ico_acc_editar.gif" style="border: 0;" title="Editar" /><br />
						    Editar
					    </a>
				    </div>	
					    ...
					    <div class="dv_tabla_contenedora">
						    <table id="tb_formulario" style="border: 0;" cellpadding="0" cellspacing="3">
							    ...
							    <tr>
							        ...
							        <td class="input"><input id="txtContrato" name="txtContrato" type="text" class="css_input" size="12" tabindex="1" /></td>
		        				    <td class="label">CU Cliente</td>
								    <td class="input"><input id="txtCuCliente" name="txtCuCliente" type="text" class="css_input" tabindex="2" /></td>								    
								    <td class="label">Razón Social o Nombre</td>
								    <td class="input"><input id="txtRazonSocial" name="txtRazonSocial"  type="text" class="css_input" size="70" tabindex="3" /></td>
							    </tr>
							    <tr>
							        <td class="label">N° Cotización</td>
							        <td class="input"><input id="txtCotizacion" name="txtCotizacion" type="text" class="css_input" size="12" tabindex="4" /></td>
							        <td class="label">Fecha Inicio</td>
								    <td class="input"><input id="txtFechaIni" name="txtFechaIni" type="text" class="css_input" size="11" tabindex="5" /></td>
								    <td class="label">Fecha Final</td>
							        <td class="input"><input id="txtFechaFin" name="txtFechaFin" type="text" class="css_input" size="11" tabindex="6" /></td>
							    </tr>
							    <tr>
							    ...
							    <tr>
							     ...
							     <td class="input">
                                  ...
                                  <td class="input"><input id="txtKardex" name="txtKardex" type="text" class="css_input" size="11" tabindex="15" /></td>	
