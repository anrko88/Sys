<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmObservacion.aspx.vb" Inherits="Formalizacion_frmObservacion" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmObservacion.aspx.js"> </script>
    ...
    <div id="dv_cuerpoModal">
	    <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0" style="width:100%">
	        <tr>
			                ...
			                <td class="titulos">
				                ...
				                <div class="css_lbl_titulo">Observaciones Legal</div>
			                </td>
			                <td class="espacio">&nbsp;
        ...
        <br>
            ...
            <table id="tb_formulario" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="label">Tipo de Observación</td>
                    <td class="input">
	        ...
	        <tr>
                ...
                <td class="input">
                            <textarea id="TxaObs" name="TxaObs" rows="4" cols="20"  style="width:400px" runat="server" ></textarea>
                </td>
            </tr>
            </table>
