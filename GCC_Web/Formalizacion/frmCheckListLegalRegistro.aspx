<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmCheckListLegalRegistro.aspx.vb" Inherits="Formalizacion_frmCheckListLegalRegistro" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmCheckListLegalRegistro.aspx.js" > </script>
...
<form id="frmChecklistRegistro" runat="server">
	    ...
	    <table id="tb_cuerpoCabecera" border="0" cellpadding="0" cellspacing="0">
		    <tr>
			    ...
			    <td class="titulos">
				    ...
				    <div class="css_lbl_titulo" id="lbl_titulo">Checklist Legal :: Editar</div>
			    </td>
			    <td class="espacio">
			        &nbsp;    								
			    </td>
			    <td class="botones">    				
				   ...
				   <div id="dv_img_boton" class="dv_img_boton">
				     ...
				     <div id="dv_Aprobar" class="dv_img_boton">
                     ...
                     <div id="dv_Devolver" class="dv_img_boton">
					    <a href="javascript:fn_devolver();">
				        ...
				        <div id="dv_datos"  class="dv_tabla_contenedora" >
					         <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" style="width:100%;" >
						        ...
						        <tr>
						            ...
						            <td class="input"><input id="txtNumeroContrato" name="txtNumeroContrato" type="text" class="css_input_inactivo" size="30" value="" disabled="disabled" readonly="readonly" runat="server" /></td>
	                            ...
	                            <tr>	
							        ...
							        <td class="input"><input id="txtEstadoBien" name="txtEstadoBien" type="text" class="css_input_inactivo" size="30" value="" disabled="disabled" readonly="readonly" runat="server" /></td>  
							    </tr>
							    <tr>
   						            <td class="label">CU Cliente</td>
							        <td class="input"><input id="txtCuCliente" name="txtCuCliente" type="text" class="css_input_inactivo" size="12" value="" disabled="disabled" readonly="readonly"  runat="server"/></td>
							        ...
							        <td colspan="3" class="input"><input id="txtrazonSocial" name="txtrazonSocial" type="text" class="css_input" size="100" value="" runat="server" /></td>
								</tr>
								<tr>
    					 ...
    					 <div id="divTabs" style="border:0px; background:none;" class="dv_tabla_contenedora"  >
                                ...
                                <div id="tab-0" > 
                                    <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" style="width:80%;">                                           
                                        <tr>
                                            ...
                                            <td class="input" colspan="6"><input id="txtUbicacion" name="txtUbicacion" type="text" class="css_input" size="117" value="" runat="server" /></td>
                                        </tr>
                                         <!--
				                ...
				                <div id="tab-2" >				                    
                                    ...
                                    <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" >
                                        ...
                                        <tr>
                                            ...
                                            <td class="label" id="td_lblDepartamento"  style="width:150px;">Departamento</td>
                                            <td class="input" id="td_InpDepartamento"  style="width:250px;">
                                ...
                                <div id="tab-3">                                    
                                    <table  id="tb_formulario" border="0" cellpadding="0" cellspacing="5"  style="width:100%;" >				
                                        <tr>
                                            ...
                                            <td class="input"><input id="txtNumeroCuenta1" name="txtNumeroCuenta1" type="text"  size="20" value="" runat="server" /></td>
                                        </tr>    
                                        <tr>
                                            ...
                                            <td class="label">Nº Cuenta</td>
                                            <td class="input"><input id="txtNumeroCuenta2" name="txtNumeroCuenta2" type="text" size="20" value="" runat="server" /></td>
                                        </tr>
                                    </table>                           
                                </div>
                                ...
                                <!-- ****************************** -->  
    				            <div id="tab-4">
		                            <div id="CotizacionAgregar" style="border:0px;">
                                        <table id="tb_formulario" border="0" cellpadding="0" cellspacing="3" style="width:80%;">
                                        <tr>
	                                            <td colspan="4" align="left">  
                                                    <div id="Div16" class="dv_img_boton_mini" style="height:28px;border:0">
                                                        <a href="javascript:fn_AgregarDocumentos();" >
                                                        <img alt="" src="../Util/images/ico_acc_agregar.gif" style="width:16px; height:16px;display:inline;" border="0" />Agregar
                                                        </a>
                                                    </div>  
                                                </td>
    ...
    <input type="button" name="btnCancelar" id="btnCancelar" onclick="javascript:fn_Cancelar();" style="display:none;"/>
    <input type="button" name="btnCancelar2" id="btnCancelar2" onclick="javascript:fn_Cancelar2();" style="display:none;"/>
    ...
    <!--Agrega a la lista de Representantes-->
        ...
        <input id="hddCodigoEstadoContrato" name="hddCodigoEstadoContrato" type="hidden" runat="server" />
        
        
         <input type="button" name="btnBuscar" id="Button1" onclick="javascript:fn_cargaDocumentos();" style="display:none;"/>
         <input type="button" name="btnCancelar" id="btnCancelar" onclick="javascript:fn_cancelar();" style="display:none;"/>
        ...
        <input id="hddTotalAprobacionDocumentos" name="hddTotalAprobacionDocumentos" type="hidden" runat="server" />  
        ...
        <input id="hddTotalRegistrosDocAdd" name="hddTotalRegistrosDocAdd" type="hidden" runat="server" />
        <input id="hddTotalValidadadosDocAdd" name="hddTotalValidadadosDocAdd" type="hidden" runat="server" />
