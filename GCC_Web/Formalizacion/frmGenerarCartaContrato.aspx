<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGenerarCartaContrato.aspx.vb" Inherits="Formalizacion_frmGenerarCartaContrato" %>
...
<head id="Head1" runat="server">
	...
	<!-- Local -->	
	<script type='text/javascript' src="frmGenerarCartaContrato.aspx.js"></script>
    ...
    <table id="tb_tabla_comun" border="0" cellpadding="0" cellspacing="0" style="width:100%; padding-right: 0px;" >
      <tr>
        ...
        <table border="0" cellpadding="0" width="80%">
            <tr>
                <td>
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Util/images/question.gif"/>
                </td>
                <td>
