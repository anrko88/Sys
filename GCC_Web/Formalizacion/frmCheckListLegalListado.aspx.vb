...
Partial Class Formalizacion_frmCheckListLegalListado
    Inherits GCCBase

    Dim objLog As New GCCLog("frmCheckListLegalListado.aspx.vb")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                'GCCUtilitario.CargarComboValorGenerico(cmbClasificacionContrato, GCCConstante.C_TABLAGENERICA_CLASIFICACION_CONTRATO)
                GCCUtilitario.CargarComboValorGenerico(cmbClasificacionContrato, GCCConstante.C_TABLAGENERICA_CLASIFICACION_BIEN)
    ...
    Public Shared Function ListadoContratoCotizacion(ByVal pPageSize As Integer, _
        ...
        Try
            ...
            With oECotizacion
                ...
                .CodigoClasificacionContrato = Nothing
            ...
            Return objJQGridJsonResponse.JQGridJsonResponseDataTable(totalPages, currentPage, totalRecords, odtbListado)
