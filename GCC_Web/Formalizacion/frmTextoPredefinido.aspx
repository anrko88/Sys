<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmTextoPredefinido.aspx.vb" Inherits="Formalizacion_frmTextoPredefinido" %>
	    ...
	    <table id="tb_cuerpoCabecera" cellpadding="0" cellspacing="0" style="width:100%; border: 0;">
	        <tr>
                ...
                <td class="botones">
	                ...
	                <div id="dv_img_boton_grabar" class="dv_img_boton" >
		                <a href="javascript:fn_grabar();">
			                <img src="../Util/images/ico_acc_grabar.gif" style="border: 0px;" alt="" /><br />
			                Guardar
		                </a>
	                </div>	
                ...
                <tr>                        
                    <td class="input" style="text-align:center;border: 1px;">
                        <div style="text-align:left;border: 1px;">
                            <textarea id="txaTextoPredefinido" name="txaTextoPredefinido" rows="16" cols="90" style="width: 98%; font-family: Courier New; font-size: 11px;" runat="server"></textarea>
                            <br />
                        </div>
                    </td>
                </tr>
